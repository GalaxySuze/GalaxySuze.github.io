(function () {
    var siteConfig = {
        ...
        "settings": {
            ...
            "css": {
                ...
                ".bdcs-search-form-input:focus": {"border-color": "#1a89ed"},
        ...
        "isUrlEmpty": 0,
        "isGbk": false,
        "settings_2": {"useSliding": 0},
        "settings_3": {"usePopup": 0},
        "settings_4": {"useFloat": 0},
        "settings_5": {"useCustom": 0}
    };
    siteConfig.logId = '3487466962';
    var bdcsTpl = '<meta http-equiv="x-ua-compatible" content="IE=9" >\n<%if(settings.useSetting){%>\r\n<!-- 嵌入式 -->\r\n<div class="bdcs-main bdcs-clearfix" id="default-searchbox">\r\n    <div class="bdcs-search bdcs-clearfix" id="bdcs-search-inline">\r\n        <form action="<%=resultUrl%>" method="get" target="<%=resultTarget%>" class="bdcs-search-form" autocomplete="off" id="bdcs-search-form">\r\n            <input type="hidden" name="s" value="<%=siteId%>" />\r\n            <input type="hidden" name="entry" value="1" />\r\n            <% var charset = document.charset || document.characterSet; %>\r\n            <% if(isGbk || charset.toLowerCase() == \'gbk\' || charset.toLowerCase() == \'gb2312\') { %>\r\n                <input type="hidden" name="ie" value="gbk" />\r\n            <% } %>\r\n\r\n            <% if(settings.inurl) {%>\r\n                <input type="hidden" name="inurl" value="<%=settings.inurl%>" />\r\n            <% } %>\r\n            <% if(channelList[0]) {%>\r\n                <input type="hidden" name="cid" value="<%=channelList[0]%>" />\r\n            <% } %>\r\n            <% if(settings.useChannels && settings.customChannel.length != 0) {%>\r\n            <div class="default-channel-meun" id="default-channel-meun">\r\n                <div class="default-channel-current"><span id="default-channel-curr"><%= settings.customChannel[0].name %></span><i></i></div>\r\n\r\n                <input type="hidden" name="nsid" value="<%= settings.customChannel[0].key %>" id="default-channel-nsid"/>\r\n            </div><% } %><input type="text" name="q" class="bdcs-search-form-input" id="bdcs-search-form-input" placeholder="<%= (settings.useSetting ? window.bdcs.utils.encodeHTML(settings.inputPlaceholder) : \'\')%>" />\r\n            <input type="submit" class="bdcs-search-form-submit <%= (settings.useSetting && settings.useInputSubmitMagnifier ? "bdcs-search-form-submit-magnifier" : "") %>" id="bdcs-search-form-submit" value="<%= (settings.useSetting ? window.bdcs.utils.encodeHTML(settings.inputSubmitValue) : \'搜索\') %>" />             \r\n        </form>\r\n    </div>\r\n    <% if(settings.useSug) {%>\r\n        <div class="bdcs-search-sug" id="bdcs-search-sug">\r\n            <ul class="bdcs-search-sug-list" id="bdcs-search-sug-list"></ul>\r\n        </div>\r\n    <% } %>\r\n\r\n    <% if(settings.useHot) {%>\r\n    	<div class="bdcs-hot" id="bdcs-hot">\r\n        	\r\n		</div>\r\n	<% } %>\r\n\r\n</div>\r\n<% } %>   \r\n    \r\n    <% if(settings_2.useSliding) {%>                   \r\n<!-- 侧滑式 -->\r\n        <div id="sliding-searchbox" class="<%=settings_2.slidingTemplate %>">\r\n            <form action="<%=resultUrl%>" method="get" target="<%=resultTarget%>" class="bdcs-search-form" id="sliding-search-form">\r\n                <div id="sliding-box-detail">\r\n                    <div id="sliding-icon-left"></div>\r\n                    <div id="sliding-back-right"></div>\r\n                    <div class="sliding-box-item" id="sliding-box-item"> \r\n\r\n                    	<div class="sliding-box-meun bdcs-clearfix" id="sliding-box-meun">\r\n\r\n            		<% if(settings_2.useChannels && settings_2.customChannel.length != 0) {%>\r\n            		<div class="sliding-channel-meun" id="sliding-channel-meun">\r\n            			<div class="sliding-channel-current"><span id="sliding-channel-curr"><%=settings_2.customChannel[0].name %></span><i></i></div>\r\n\r\n            			<input type="hidden" name="nsid" value="<%= settings_2.customChannel[0].key %>" id="sliding-channel-nsid"/>\r\n            		</div><% } %><input type="text" name="q" class="bdcs-search-form-input" id="sliding-search-form-input" placeholder="<%= (settings_2.useSliding ? window.bdcs.utils.encodeHTML(settings_2.slidingInputPlaceholder) : \'\')%>" /><input type="submit" class="bdcs-search-form-submit <%= (settings_2.useSliding && settings_2.slidingUseInputSubmitMagnifier ? "sliding-submit-magnifier" : " ") %>" id="sliding-search-form-submit" value="<%= (settings_2.slidingInputSubmitValue ? window.bdcs.utils.encodeHTML(settings_2.slidingInputSubmitValue) : \'搜索\') %>" />\r\n	                        <input type="hidden" name="s" value="<%=siteId%>" />\r\n\r\n	            			<% var charset = document.charset || document.characterSet; %>\r\n                            <% if(isGbk || charset.toLowerCase() == \'gbk\' || charset.toLowerCase() == \'gb2312\') { %>\r\n                            <input type="hidden" name="ie" value="gbk" />\r\n                            <% } %>\r\n\r\n	            		<% if(settings_2.useSug) {%>\r\n			            <div class="bdcs-search-sug" id="sliding-search-sug">\r\n				        <ul class="bdcs-search-sug-list" id="sliding-search-sug-list"></ul>\r\n				    </div>\r\n			        <% } %>\r\n\r\n                    <% if(settings_2.useHot) {%>\r\n                        <div class="bdcs-hot" id="sliding-hot">\r\n                            \r\n                        </div>\r\n                    <% } %>\r\n\r\n	    		</div>\r\n            </div>\r\n            <div id="sliding-back"></div>\r\n            <div id="sliding-icon-right"> </div>\r\n        </div>\r\n    </form>\r\n</div>\r\n<% } %>\r\n\r\n<%if(settings_3.usePopup){%>\r\n<!-- 弹窗式 -->\r\n<div id="popup-box" class="<%=settings.popupTemplate %>">\r\n    <div id="popup-searchbox">\r\n        <div class="popup-icon"></div>\r\n        <div class="popupbox-item">\r\n        	<div id="popup-top">\r\n                <span class="top-bg"><span class="span-font"><%=settings_3.popupTitle%>:</span></span>\r\n                <span id="popup-back">一</span>\r\n            </div>\r\n            <form action="<%=resultUrl%>" method="get" target="<%=resultTarget%>" class="bdcs-search-form" id="popup-search-form">             \r\n                <div id="popup-box-detail">\r\n                    <input type="hidden" name="s" value="<%=siteId%>" />\r\n                    <% var charset = document.charset || document.characterSet; %>\r\n                    <% if(isGbk || charset.toLowerCase() == \'gbk\' || charset.toLowerCase() == \'gb2312\') { %>\r\n                    <input type="hidden" name="ie" value="gbk" />\r\n                    <% } %>\r\n\r\n                    <% if(settings_3.useChannels && settings_3.customChannel.length != 0) {%>\r\n            		<div class="popup-channel-meun" id="popup-channel-meun">\r\n            			<div class="popup-channel-current"><span id="popup-channel-curr"><%= settings_3.customChannel[0].name %></span><i></i></div>\r\n\r\n            			<input type="hidden" name="nsid" value="<%= settings_3.customChannel[0].key %>" id="popup-channel-nsid"/>\r\n            		</div><% } %><input type="text" name="q" class="bdcs-search-form-input" id="popup-search-form-input" placeholder="<%= (settings_3.usePopup ? window.bdcs.utils.encodeHTML(settings_3.popupInputPlaceholder) : \'\')%>" /><input type="submit" class="bdcs-search-form-submit <%= (settings_3.usePopup && settings_3.popupUseInputSubmitMagnifier ? "pop-submit-magnifier" : "pop-submit-nomagnifier ") %>" style="<%= (settings_3.usePopup && settings_3.popupUseInputSubmitMagnifier ? "" : "text-indent:0") %>" id="popup-search-form-submit" value="<%= (settings_3.popupInputSubmitValue ? window.bdcs.utils.encodeHTML(settings_3.popupInputSubmitValue) : \'搜索\') %>" />\r\n                    <% if(settings_3.useSug) {%>\r\n			            <div class="bdcs-search-sug" id="popup-search-sug">\r\n			                <ul class="bdcs-search-sug-list" id="popup-search-sug-list"></ul>\r\n			            </div>\r\n			        <% } %>\r\n\r\n                    <% if(settings_3.useHot) {%>\r\n                        <div class="bdcs-hot" id="popup-hot">\r\n                            \r\n                        </div>\r\n                    <% } %>\r\n\r\n                </div>\r\n            </form> \r\n        </div>\r\n    </div>\r\n</div>\r\n<%}%>\r\n\r\n<%if(settings_4.useFloat){%>\r\n<!-- 悬浮式 -->\r\n<div id="float-search-box" class="<%=settings_4.floatTemplate %>">\r\n    <div id="float-searchbox">\r\n        <form action="<%=resultUrl%>" method="get" target="<%=resultTarget%>" class="bdcs-search-form" id="float-search-form" >         \r\n            <div id="float-box-detail" class="bdcs-clearfix">\r\n                <div id="float-logo"></div>\r\n                <div id="float-box" class="bdcs-clearfix">\r\n                    <input type="hidden" name="s" value="<%=siteId%>" />\r\n                    <% var charset = document.charset || document.characterSet; %>\r\n                    <% if(isGbk || charset.toLowerCase() == \'gbk\' || charset.toLowerCase() == \'gb2312\') { %>\r\n                    <input type="hidden" name="ie" value="gbk" />\r\n                    <% } %>\r\n                            \r\n                    <% if(settings_4.useChannels && settings_4.customChannel.length != 0) {%>\r\n            		<div class="float-channel-meun" id="float-channel-meun">\r\n            			<div class="float-channel-current"><span id="float-channel-curr"><%= settings_4.customChannel[0].name %></span><i></i></div>\r\n\r\n            			<input type="hidden" name="nsid" value="<%= settings_4.customChannel[0].key %>" id="float-channel-nsid"/>\r\n            		</div><% } %><input type="text" name="q" class="bdcs-search-form-input" id="float-search-form-input" placeholder="<%= (settings_4.floatInputPlaceholder ? window.bdcs.utils.encodeHTML(settings_4.floatInputPlaceholder) : \'\')%>" /><input type="submit" class="bdcs-search-form-submit <%= (settings_4.useFloat && settings_4.floatUseInputSubmitMagnifier ? "float-submit-magnifier" : " ") %>" id="float-search-form-submit" value="<%= (settings_4.floatInputSubmitValue ? window.bdcs.utils.encodeHTML(settings_4.floatInputSubmitValue) : \'搜索\') %>" />\r\n                    <% if(settings_4.useSug) {%>\r\n                        <div class="bdcs-search-sug" id="float-search-sug">\r\n                            <ul class="bdcs-search-sug-list" id="float-search-sug-list"></ul>\r\n                        </div>\r\n                    <% } %>\r\n\r\n                    <% if(settings_4.useHot) {%>\r\n                        <div class="bdcs-hot bdcs-clearfix" id="float-hot">\r\n                            \r\n                        </div>\r\n                    <% } %>\r\n\r\n                </div>\r\n           </div>\r\n        </form> \r\n    </div>    \r\n</div>\r\n<%}%>\r\n',
        ...
        AceTemplate = function () {
            function e(e) {
                var t = [];
                return t.push("with(this){"), t.push(e.replace(/<(script|style)[^>]*>[\s\S]*?<\/\1>/g, function (e) {
                    return ['#{decodeURIComponent("', encodeURIComponent(e), '")}'].join("")
                }).replace(/[\r\n]+/g, "\n").replace(/^\n+|\s+$/gm, "").replace(/((^\s*[#<].*$)\s?)+/gm, function (e) {
                ...
                })), t.push("}"), new Function("_output_", "helper", t.join(""))
            }
            ...
            function i(e, t) {
                var n, s = e || {};
                for (n in t) t.hasOwnProperty(n) && ("[object Object]" === Object.prototype.toString.call(t[n]) ? (e[n] = e[n] || {}, s[n] = i(e[n], t[n])) : s[n] = t[n]);
                return s
            }
            ...
            function c() {
                ...
                return e.style.cssText = "float:left", e.style.cssFloat ? "cssFloat" : "styleFloat"
            }

            function d(e, t) {
                var i = "float" === t ? c() : a(t), n = l(t);
            ...
            function f(e, t) {
                var i, n, s = t;
                if ("string" == typeof t && (s = s.split(" ")), 1 === e.nodeType) if (e.className || 1 !== s.length) for (var o = 0, r = s.length; r > o; o++) i = s[o], n = new RegExp("\\b(" + i + ")\\b"), n.test(e.className) || (e.className = e.className + " " + i); else e.className = s[0];
                e.className = g(e.className), e.className = p(e.className)
            }

            function m(e) {
                var t = e.elements, i = "";
                if (t) {
                    for (var n = 0; n < t.length; n++) ("hidden" == t[n].type || "text" == t[n].type) && n < t.length - 1 && "" != t[n].name && (i += t[n].name + "=" + t[n].value + "&"), "hidden" != t[n].type && "text" != t[n].type || n != t.length - 1 || "" != t[n].name && (i += t[n].name + "=" + t[n].value);
                    return i
                }
                return ""
            }
            ...
            function C(e, t, i) {
                document.addEventListener ? e.addEventListener(t, i, !1) : document.attachEvent && e.attachEvent("on" + t, function (t) {
            ...
            function y(e) {
                var t = navigator.userAgent.toLowerCase(), i = -1 != t.indexOf("opera"),
                ...
                if (document.getBoxObjectFor) {
                    ...
                    if (r = [n.offsetLeft, n.offsetTop], o = n.offsetParent, o != n) for (; o;) r[0] += o.offsetLeft, r[1] += o.offsetTop, o = o.offsetParent;
                    (-1 != t.indexOf("opera") || -1 != t.indexOf("safari") && "absolute" == n.style.position) && (r[0] -= document.body.offsetLeft, r[1] -= document.body.offsetTop)
                }
                for (o = n.parentNode ? n.parentNode : null; o && "BODY" != o.tagName && "HTML" != o.tagName;) r[0] -= o.scrollLeft, r[1] -= o.scrollTop, o = o.parentNode ? o.parentNode : null;
                return {x: r[0], y: r[1]}
            }
            ...
            function _(e) {
                ...
                return n.style.cssText = "position: absolute; top: 0; left: 0", document.body.appendChild(n), t = n.getBoundingClientRect().top, i = n.getBoundingClientRect().left, document.body.removeChild(n), n = null, {
            ...
            function k(e, t) {
                ...
                i.readyState ? i.onreadystatechange = function () {
                    ...
                    t()
                }, i.src = e, i.charset = "utf-8", i.async = !0, document.getElementsByTagName("head")[0].appendChild(i)
            }
            ...
            function T(e, t, i) {
                var n, s = Array.prototype.indexOf, o = e.length;
                if (0 === o) return -1;
    ...
    utils.DOMReady = function (e) {
        ...
        var i, n = [], s = !1, o = document, r = o.documentElement, a = r.doScroll, l = "DOMContentLoaded",
            c = "addEventListener", d = "onreadystatechange", u = "readyState", g = a ? /^loaded|^c/ : /^loaded|c/,
            p = g.test(o[u]);
        return o[c] && o[c](l, i = function () {
            o.removeEventListener(l, i, s), t()
        }, s), a && o.attachEvent(d, i = function () {
            /^c/.test(o[u]) && (o.detachEvent(d, i), t())
        }), e = a ? function (t) {
        ...
        function e() {
            this.events = {}, this.on = this.bind, this.off = this.remove, this.emit = this.trigger
        }

        return e.prototype.bind = function (e, t, i) {
            var n, s;
            return this.events[e] = this.events[e] || [], s = this.events[e], n = {
                handler: t,
                context: i
            }, s.push(n), this
        }, e.prototype.once = function (e, t, i) {
            function n() {
                s.remove(e, n), t.apply(this, arguments)
            }

            var s = this;
            return n.handler = t, this.bind(e, n, i), this
        }, e.prototype.trigger = function () {
            var e = arguments[0], t = this.events[e] || [], i = Array.prototype.slice.call(arguments, 1);
            t = Array.prototype.slice.call(t, 0);
            for (var n = 0, s = t.length; s > n; n++) t[n].handler.apply(t[n].context || this, i);
            return this
        }, e.prototype.remove = function (e, t) {
            var i = this.events[e] || [];
            if (0 === arguments.length) return this.events = {}, this;
            if (1 === arguments.length) return this.events[e] = [], this;
            for (var n = 0, s = i.length; s > n; n++) if (i[n].handler === t || i[n].handler.handler === t) {
                i.splice(n, 1);
                break
            }
            return this
    ...
    var FlyJSONP = function (e) {
        ...
        return i = function (e, t, i) {
            ...
            t.log("Garbage collecting!"), n.parentNode.removeChild(n), e[i] = void 0;
            try {
                delete e[i]
            } catch (s) {
            }
            ...
            var e = "", t = [], i = "0123456789ABCDEF", n = 0;
            for (n = 0; 32 > n; n += 1) t[n] = i.substr(Math.floor(16 * Math.random()), 1);
            return t[12] = "4", t[16] = i.substr(3 & t[16] | 8, 1), e = "flyjsonp_" + t.join("")
        }, r = function (e, i) {
            t.log(i), "undefined" != typeof e && e(i)
        }, a = function (e, i) {
            t.log("GET success"), "undefined" != typeof e && e(i), t.log(i)
        }, l = function (e, i) {
            t.log("POST success"), "undefined" != typeof e && e(i), t.log(i)
        }, c = function (e) {
            t.log("Request complete"), "undefined" != typeof e && e()
        }, t = {}, t.options = {debug: !1}, t.init = function (e) {
            var i;
            t.log("Initializing!");
            ...
            d = d || {};
            var u = d.url, g = d.callbackParameter || "callback", p = d.parameters || {},
                f = e.document.createElement("script"), m = o(), h = "?";
            if (!u) throw new Error("URL must be specified!");
            p[g] = m, u.indexOf("?") >= 0 && (h = "&"), u += h + s(p, !0), e[m] = function (e) {
                "undefined" == typeof e ? r(d.error, "Invalid JSON data returned") : "post" === d.httpMethod ? (e = e.query.results, e && e.postresult ? (e = e.postresult.json ? e.postresult.json : e.postresult, l(d.success, e)) : r(d.error, "Invalid JSON data returned")) : a(d.success, e), n(m, f), c(d.complete)
            }, t.log("Getting JSONP data"), f.setAttribute("src", u), f.setAttribute("charset", "utf-8"), e.document.getElementsByTagName("head")[0].appendChild(f), i(f, "error", function () {
                n(m, f), c(d.complete), r(d.error, "Error while trying to access the URL")
            })
        }, t.post = function (e) {
            e = e || {};
            var i, n, o = e.url, r = e.parameters || {}, a = {};
    ...
    var pageLog = {
        ...
        }, adLog = {version: "1.0", logid: siteConfig.logId, site_id: siteConfig.siteId, clk_type: 0, log_type: 1},
        adDispLog = {version: "1.0", logid: siteConfig.logId, site_id: siteConfig.siteId, disp_type: 0, log_type: 0},
        bdcsUtils = function () {
            function insertCSS(e, t, i) {
                t = t === !1 ? !1 : !0, i = i || "bdcs-styleElem", t && (e = (e || "").replace(bdcsClassRegex, ".bdcs-container .bdcs-"));
                var n = document.getElementById("znBdcsStyle");
                if (n) n.styleSheet ? (cssCache.push(e), n.styleSheet.cssText = cssCache.join("\n")) : n.appendChild(document.createTextNode(e)); else {
                    var s = document.createElement("style");
                    s.id = "znBdcsStyle", s.rel = "stylesheet", s.type = "text/css";
            ...
            function getCSSFromSetting(e) {
                var t = e + "{", i = siteConfig.settings.css[e];
            ...
            var bdcsClassRegex = /\.bdcs-/g, cssCache = [];
            return {insertCSS: insertCSS, removeCSS: removeCSS, getCSSFromSetting: getCSSFromSetting, getNest: getNest}
        }();
    window.bdcs = {
        utils: {
    ...
    var log = function () {
        function e(e) {
            var t = "_rpLog-" + (new Date).getTime(), i = new Image;
        ...
        function i(i) {
            ...
            for (var l = 1, c = arguments.length; c > l; l++) "[object Object]" === Object.prototype.toString.call(arguments[l]) && (o = t(o, arguments[l]));
            for (var n in o) r.push(n + "=" + o[n]);
            e(a + r.join("&")), "[object Function]" === Object.prototype.toString.call(arguments[arguments.length - 1]) && arguments[arguments.length - 1].call()
        }
        ...
        function l(t) {
            var i = {placeholderColor: "#888", paddingLeft: 3, type: "labelFocusEmpty"};
            this.options = e(i, t || {}), this.placeholderPuppet, this.focusTimer, this.banKeyCode = [27, 37, 38, 39, 40], this.init()
        }
        ...
        return l.prototype.init = function () {
            var e, t = this.options.inputElem, i = this;
                ...
                switch (this.createPlaceholderPuppet(), e = this.placeholderPuppet, this.options.type) {
                    case"labelInputEmpty":
                        a(e, "click", function () {
                            ...
                            -1 === utils.indexOf(i.banKeyCode, t.keyCode) && i.hidePlaceholderPuppet()
                        }), a(t, "keyup", function () {
                            i.checkInputEmpty()
                        }), a(t, "propertychange", function () {
                            i.checkInputEmpty()
                        }), a(t, "blur", function (e) {
                            i.checkInputEmpty(), 9 == c && ("focus" === e.type ? document.addEventListener("selectionchange", function () {
                                i.checkInputEmpty()
                            }, !1) : document.removeEventListener("selectionchange", function () {
                                i.checkInputEmpty()
                            }, !1))
                        }), a(t, "focus", function (e) {
                            9 == c && ("focus" === e.type ? document.addEventListener("selectionchange", function () {
                                i.checkInputEmpty()
                            }, !1) : document.removeEventListener("selectionchange", function () {
                                i.checkInputEmpty()
                            }, !1))
            ...
            var e = this.options.inputElem, i = e.getAttribute("placeholder"),
                n = (o(e, "height"), o(e, "line-height"), o(e, "font-size")), s = o(e, "font-family"),
                a = (o(e, "padding-top"), o(e, "padding-bottom"), o(e, "borderTopWidth"), o(e, "borderBottomWidth"), o(e, "margin-top")),
                l = o(e, "margin-bottom"), c = o(e, "margin-left"), d = t(e);
            inputElemOuterHeight = d.bottom - d.top, inputElemOuterWidth = d.right - d.left, this.placeholderPuppet = document.createElement("label"), this.placeholderPuppet.setAttribute("for", e.id || ""), this.placeholderPuppet.setAttribute("id", e.id + "-label" || ""), this.placeholderPuppet.innerHTML = i, r(this.placeholderPuppet, {
                cursor: "text",
                position: "absolute",
        ...
        function l(e) {
            for (var t = 0, i = 0; e;) t += e.offsetTop, i += e.offsetLeft, e = e.offsetParent;
            return {top: t, left: i}
        }
        ...
        function g(e, t) {
            var i, n, s = t;
            if ("string" == typeof t && (s = s.split(" ")), 1 === e.nodeType) if (e.className || 1 !== s.length) for (var o = 0, r = s.length; r > o; o++) i = s[o], n = new RegExp("\\b(" + i + ")\\b"), n.test(e.className) || (e.className = e.className + " " + i); else e.className = s[0];
            e.className = d(e.className), e.className = u(e.className)
        }

        function p(e, t) {
            var i, n, s = t;
            if ("string" == typeof t && (s = s.split(" ")), 1 === e.nodeType && e.className) for (var o = 0, r = s.length; r > o; o++) i = s[o], n = new RegExp("\\b(" + i + ")\\b"), n.test(e.className) && (e.className = e.className.replace(n, " "));
            e.className = d(e.className) || "", e.className = u(e.className) || ""
        }
        ...
        function C(t) {
            ...
            this.options = e(i, t || {}), this.dataCache = {}, this.sugJsonData = {}, this.selectedIndex = -1, this.inputTimer, this.intervalTimer, this.preValue, this.valueCache, this.init()
        }
        ...
        return C.prototype.init = function () {
            ...
            this.bindSugListItemEvent(), this.addLog()
        }, C.prototype.bindInputEvent = function () {
            var e = this.options.inputElem, n = this, s = this.keydownHandler(),
                o = (this.keyupHandler(), this.inputHandler());
            i(e, "keydown", s), i(e, "input", function () {
                o(), window.bdcs.search_input_time || (window.bdcs.search_input_time = +new Date)
            }), i(e, "propertychange", function () {
                o(), window.bdcs.search_input_time || (window.bdcs.search_input_time = +new Date)
            }), i(e, "blur", function (e) {
                9 == y && ("focus" === e.type ? document.addEventListener("selectionchange", o, !1) : document.removeEventListener("selectionchange", o, !1)), setTimeout(function () {
                    n.hideSug()
                }, n.options.delay)
            }), i(e, "focus", function (e) {
                setTimeout(function () {
                    n.prepareSug()
                }, n.options.delay), 9 == y && ("focus" === e.type ? document.addEventListener("selectionchange", o, !1) : document.removeEventListener("selectionchange", o, !1))
            }), i(this.options.sugListElem, "mouseout", function () {
                n.selectedIndex = -1
            }), this.options.submitElem && i(this.options.submitElem, "click", function (e) {
                t(n.getCurrentValue()) && e.preventDefault()
            })
        }, C.prototype.bindIntervalEvent = function () {
            var e = this.options.inputElem, n = this, s = this.keydownHandler();
            this.inputHandler(), i(e, "focus", function () {
                n.intervalTimer && clearInterval(n.intervalTimer), n.intervalTimer = setInterval(function () {
                    n.prepareSug()
                }, 100)
            }), i(e, "blur", function () {
                n.intervalTimer && clearInterval(n.intervalTimer), setTimeout(function () {
                    n.hideSug()
                }, n.options.delay)
            }), i(e, "keydown", s), i(e, "input", function () {
            ...
            var e = this;
            h(this.options.sugListElem, "mouseover", this.options.itemClassName, function (t) {
                var i = (t.target || t.srcElement, e.getCurrentValue());
                e.clearCurrent(), e.highlightItem(i, this), e.selectedIndex = this.getAttribute("data-index")
            }), h(this.options.sugListElem, "mouseout", this.options.itemClassName, function (t) {
                var i = t.target || t.srcElement;
                dataValue = "LI" == i.nodeName ? i.getAttribute("data-value") : i.parentNode.getAttribute("data-value"), dataValue ? h(e.options.sugElem, "mouseout", e.options.adRightClassName, function () {
                    e.clearCurrent()
                }) : e.clearCurrent()
            }), h(this.options.sugListElem, "click", this.options.itemClassName, function (t) {
                t.target || t.srcElement, e.selectCurrent(), log.send(urlConfig.log, pageLog, {
            ...
            var e = this.options.inputElem, t = c(this.options.inputElem);
            e.setAttribute("autocomplete", "off"), this.options.inputElemOuterHeight = t.bottom - t.top, this.options.inputElemOuterWidth = t.right - t.left, this.options.inputElemOffset = l(this.options.inputElem);
            ...
            return function (t) {
                switch (t.keyCode) {
                    ...
                    case 13:
                        var i;
                        i = e.selectedIndex > -1 ? "sug" : "normal", e.selectCurrent(), log.send(urlConfig.log, pageLog, {
                            search_input_time: window.bdcs.search_input_time,
                            query: encodeURIComponent(e.getCurrentValue()),
            ...
            var t = this, i = this.options.url, n = "", s = this.options.data || {};
            for (var o in s) s.hasOwnProperty(o) && (n += "&" + o + "=" + s[o]);
            i = i.indexOf("?") >= 0 ? this.options.url + "&" + this.options.param + "=" + encodeURIComponent(e) + n : this.options.url + "?" + this.options.param + "=" + encodeURIComponent(e) + n, FlyJSONP.get({
                url: i,
                success: function (i) {
                    t.cacheData(e, i.data), t.renderSugList(e)
                }
            })
        }, C.prototype.cacheData = function (e, t) {
            this.dataCache[e] = t.sug, this.sugJsonData[e] = t
            ...
            if (e) {
                ...
                if (siteConfig.settings) {
                    ...
                    if (n && n.length > 0) {
                        ...
                        this.options.sugListElem.innerHTML = s, eventEmitter.emit("sug:assertSugListItem", this.sugJsonData[e], this), eventEmitter.emit("sug:beforeHideRightSug"), eventEmitter.emit("sug:beforeHideSug"), this.showSug()
                    } else this.hideSug()
                }
            }
        }, C.prototype.dispose = function () {
        }, C.prototype.hideSug = function () {
            eventEmitter.emit("sug:beforeHideSug", this), this.options.sugElem.style.display = "none", this.getCurrentValue().length > 0 ? (this.preValue = this.valueCache, this.valueCache = this.getCurrentValue()) : (this.preValue = "", this.valueCache = ""), this.preValue = "", this.selectedIndex = -1
        }, C.prototype.showSug = function () {
            var e = this.getCurrentValue(), t = this.options.sugElem;
            ...
            if (this.isShowSug() && (e = this.options.sugListElem, t = e.getElementsByTagName("li").length, this.selectedIndex == t - 1 ? this.selectedIndex = -1 : ++this.selectedIndex, i = e.getElementsByTagName("li")[this.selectedIndex], this.clearCurrent(), i && this.highlightItem(n, i), this.options.completeWhenKeyUpDown)) if (-1 == this.selectedIndex) this.options.inputElem.value = this.valueCache, this.preValue = this.valueCache;
                ...
                this.preValue = s, this.options.inputElem.value = s
            }
            ...
            eventEmitter.emit("sug:beforeHighlightItem", t, this.sugJsonData[e], this), g(t, this.options.currentClassName)
            ...
            if (e) {
                ...
                this.options.inputElem.value = m(this.options.valueClassName, e)[0].innerHTML, this.hideSug(), navigator.userAgent, this.options.inputElem.blur(), window.bdcs.search_input_time = t
            }
        }, C.prototype.submit = function () {
            window.bdcs.search_input_time && (window.bdcs.search_input_time = 0), t(this.getCurrentValue()) || this.options.formElem.submit()
        }, C.prototype.focus = function () {
            window.bdcs.search_input_time && (window.bdcs.search_input_time = 0), this.options.inputElem.focus()
        }, C.prototype.addLog = function () {
            var e = this;
            h(this.options.sugElem, "click", this.options.adRightClassName, function (t) {
                var i = t.target || t.srcElement;
            ...
            }), h(this.options.sugElem, "click", this.options.adSkinClassName, function (t) {
                var i = t.target || t.srcElement;
                log.send(urlConfig.adClickLog, adLog, {
                    ad_id: i.getAttribute("data-id"),
                    ad_price: i.getAttribute("data-num"),
        ...
        return i.prototype.init = function (t) {
            function i() {
                var e = "getSelection" in window, t = document.getElementById("selectsearch-icon");
                t && t.parentNode.removeChild(t), setTimeout(function () {
            ...
            function n(e, i, n) {
                ...
                } else var c = i.boundingLeft + i.boundingWidth, a = i.boundingTop > 35 ? i.boundingTop - 35 + s : s,
                    l = c + 70 > document.documentElement.clientWidth ? document.documentElement.clientWidth - 65 + o : c + o;
                var d = document.createElement("img");
                d.src = "http://img.baidu.com/img/iknow/qb/select-search.png", d.alt = "搜索", d.style.cssText = "width:65px; height:31px; border:0px none;";
                var u = document.createElement("a");
                u.id = "selectsearch-icon", u.style.cssText = "cursor:pointer; position:absolute;", u.onclick = function () {
                    u.parentNode.removeChild(u), t.inputElem.value = n, t.formElem.submit();
                    var e = "zone";
                ...
                }, u.style.left = l + "px", u.style.top = a + "px", u.appendChild(d), document.body.appendChild(u), d.onmouseup = function (e) {
    ...
    znDefultBox.index = function () {
        function e(e, t, i) {
            utils.addEvent(document.getElementById(e), "submit", function () {
        ...
        var t, i = 1, n = function () {
            new Placeholder({inputElem: document.getElementById("bdcs-search-form-input"), type: "labelFocusEmpty"});
            ...
            bdcsUtils.insertCSS(searchCSS + o), siteConfig.settings.useSetting && siteConfig.settings.useSug && (bdcsUtils.insertCSS(sugCSS), bdcsUtils.insertCSS(".bdcs-container{overflow:visible;}", !1)), siteConfig.settings.useChannels && siteConfig.settings.customChannel.length > 0 && bdcsUtils.insertCSS(".bdcs-search-form-input{width:" + (parseInt(siteConfig.settings.css[".bdcs-search-form-input"].width) - parseInt(siteConfig.settings.css["div#default-searchbox  .default-channel-meun"].width)) + "px;}");
            var r = parseInt(siteConfig.settings.css[".bdcs-search-form-submit"].height) + 2;
            bdcsUtils.insertCSS(".bdcs-search-form-submit{*height:" + r + "px;*margin-top:1px;}"), "MozAppearance" in document.documentElement.style && bdcsUtils.insertCSS(".bdcs-search-form-submit{height:" + r + "px;}");
            ...
            if (bdcsUtils.insertCSS(".bdcs-search-form-submit{line-height:" + a + "px;}"), 0 === parseInt(siteConfig.settings.css[".bdcs-search-form-input"]["margin-right"]) && bdcsUtils.insertCSS(".bdcs-search-form-input{margin-right:-1px;}"), s(a), siteConfig.settings.useSetting && siteConfig.settings.useSug && (bdcsUtils.insertCSS(bdcsUtils.getCSSFromSetting(".bdcs-search-sug-list-item") + bdcsUtils.getCSSFromSetting(".bdcs-search-sug-list-item-value")), "MozAppearance" in document.documentElement.style && bdcsUtils.insertCSS("#bdcs-search-inline{height:" + (r + 2) + "px;}"), siteConfig.settings.css[".bdcs-search-sug-list"] && siteConfig.settings.css[".bdcs-search-sug-list"].width && (sugListWidth = siteConfig.settings.css[".bdcs-search-sug-list"].width)), siteConfig.settings.useSetting && siteConfig.settings.useHot && (bdcsUtils.insertCSS(hotCSS), bdcsUtils.insertCSS(bdcsUtils.getCSSFromSetting(".bdcs-hot") + bdcsUtils.getCSSFromSetting(".bdcs-hot-item")), "right" === siteConfig.settings.hotPosition ? bdcsUtils.insertCSS(".bdcs-search{float:left} .bdcs-hot{float:right}") : "left" === siteConfig.settings.hotPosition && bdcsUtils.insertCSS(".bdcs-search{float:right} .bdcs-hot{float:left}")), siteConfig.settings.useSetting && siteConfig.settings.useSug) {
                switch (eventEmitter.on("sug:beforeShowSug", function (e, t) {
                    ...
                    var s = t.options.sugListElem, o = s.getElementsByTagName("li").length,
                    ...
                    if (e) {
                        ...
                        if (r >= 200 && a >= 85 && 0 != l) {
                            ...
                            d.src = e.skin.img_url, c.href = urlConfig.ad + "&ad_id=" + e.skin.ad_id + "&ad_url=" + encodeURIComponent(e.skin.target_url) + "&ad_type=search_ad_sug_show&clk_type=0", d.setAttribute("data-id", e.skin.ad_id), d.setAttribute("data-num", e.skin.charge_info.price), d.style.display = "inline", c.style.display = "block", log.send(urlConfig.adDispLog, adDispLog, {
                ...
                }), eventEmitter.on("sug:beforeHighlightItem", function (e, t, i) {
                    null != e.getAttribute("data-value") ? eventEmitter.emit("sug:beforeShowRightSug", t, e, i) : eventEmitter.emit("sug:beforeHideRightSug")
                }), eventEmitter.on("sug:assertSugListItem", function (e, t) {
                    var i = t.options.sugListElem, n = i.getElementsByTagName("li"), s = n.length,
                        ...
                        a = e.skin.length;
                    if (o >= 200 && r >= 200 && 0 == a) for (var l = 0, c = n.length; c > l; l++) if (n[l].children[0].innerHTML == e.sug[l].title && 0 != e.sug[l].charge_info) {
                        var d = document.createElement("i");
                        utils.addClass(d, "bdcs-search-sug-i"), d.innerHTML = "&gt", n[l].appendChild(d), n[l].setAttribute("data-value", e.sug[l].title), utils.addClass(n[l], " sugRightAdv"), n[l].children[0].style.display = "inline"
                    }
                }), eventEmitter.on("sug:beforeShowRightSug", function (e, t, i) {
                    var n = i.options.sugListElem, s = n.getElementsByTagName("li"),
                        ...
                        r = document.getElementById("bdcs-search-sug-adv"), a = 100, l = t.parentNode.clientHeight;
                    r.style.width = a + "px", r.style.height = l + "px", o.style.visibility = "hidden";
                    for (var c = function (e, t) {
                        var i = new Image;
                        i.src = t, i.complete ? (_containImg(e, i, a, l), e.style.visibility = "visible") : i.onload = function () {
                            _containImg(e, i, a, l), e.style.visibility = "visible", i.onload = null
                        }
                    }, d = 0, u = e.sug.length; u > d; d++) if (t.children[0].innerHTML == e.sug[d].title) {
                        r.href = urlConfig.ad + "&ad_id=" + e.sug[d].ad_id + "&ad_url=" + encodeURIComponent(e.sug[d].target_url) + "&ad_type=search_ad_sug&clk_type=0", o.src = e.sug[d].img_url, c(o, e.sug[d].img_url), o.setAttribute("data-id", e.sug[d].ad_id), o.setAttribute("data-num", e.sug[d].charge_info.price);
                        break
                    }
                    r.style.display = "block", log.send(urlConfig.adDispLog, adDispLog, {
                        ad_id: o.getAttribute("data-id"),
                        ad_price: o.getAttribute("data-num"),
                        ad_type: "search_ad_sug"
                    })
                }), eventEmitter.on("sug:beforeHideRightSug", function () {
            ...
            } else siteConfig.settings.useSetting && (utils.addEvent(document.getElementById("bdcs-search-form-input"), "input", function () {
                window.bdcs.search_input_time || (window.bdcs.search_input_time = +new Date)
            }), utils.addEvent(document.getElementById("bdcs-search-form-input"), "propertychange", function () {
                window.bdcs.search_input_time || (window.bdcs.search_input_time = +new Date)
            }));
            ...
            if (siteConfig.settings.useSetting && siteConfig.settings.useHot) {
                for (var c = utils.getElementsByClassName("bdcs-hot-item"), d = 0, u = c.length; u > d; d++) utils.addEvent(c[d], "click", function () {
                    var e = this.innerHTML, t = this.parentNode.id;
                    log.send(urlConfig.log, pageLog, {
                ...
                0 != g.length && utils.addEvent(g[0], "click", function (e) {
            ...
            if (siteConfig.settings.useChannels && siteConfig.settings.customChannel.length > 0) {
                ...
                i.className = "cse-default-channel-container", document.body.appendChild(i);
                ...
                e = "MozAppearance" in document.documentElement.style ? e + 2 : e, i.style.width = siteConfig.settings.css["div#default-searchbox  .default-channel-meun"].width, eventEmitter.on("channel:showChannel", function () {
                    i.style.left = utils.getElementPos("default-channel-meun").x + "px", i.style.top = utils.getElementPos("default-channel-meun").y + e + 2 + "px"
                }), "MozAppearance" in document.documentElement.style && 2 == parseInt(siteConfig.settings.templateId) && bdcsUtils.insertCSS("#bdcs-search-inline{height:" + (e + 2) + "px;}"), bdcsUtils.insertCSS("#bdcs-search-inline{overflow:visible;}"), bdcsUtils.insertCSS("div#default-searchbox .default-channel-current{border-radius:" + siteConfig.settings.css[".bdcs-search-form-input"]["border-radius"] + ";}"), bdcsUtils.insertCSS("div#default-searchbox .default-channel-current i{top:" + (e / 2 - 3) + "px;}"), bdcsUtils.insertCSS("div#default-searchbox .default-channel-current{height:" + e + "px;line-height:" + e + "px;border-color:" + siteConfig.settings.css[".bdcs-search-form-input"]["border-color"] + "}", !1, "aaa"), bdcsUtils.insertCSS("div#default-searchbox  .default-channel-meun{border-radius:" + siteConfig.settings.css[".bdcs-search-form-input"]["border-radius"] + ";width:" + siteConfig.settings.css["div#default-searchbox  .default-channel-meun"].width + "}");
                var a = function (e) {
                    e.stopPropagation(), utils.setStyle(o, {display: "none"})
                };
                "click" == siteConfig.settings.channelShowType ? (utils.removeEvent(s, "mouseout", a), utils.removeEvent(i, "mouseout", a), utils.addEvent(s, "click", function (e) {
                    e.stopPropagation(), "none" == utils.getStyle(o, "display") ? (eventEmitter.emit("channel:showChannel"), utils.setStyle(o, {display: "block"})) : utils.setStyle(o, {display: "none"})
                }), utils.addEvent(window, "scroll", function () {
                    siteConfig.isDemo && utils.setStyle(o, {display: "none"}), "none" == utils.getStyle(o, "display") || siteConfig.isDemo || eventEmitter.emit("channel:showChannel")
                })) : (utils.addEvent(s, "mouseover", function (e) {
                    e.stopPropagation(), "none" == utils.getStyle(o, "display") && (utils.setStyle(o, {display: "block"}), eventEmitter.emit("channel:showChannel"))
                }), utils.addEvent(i, "mouseover", function (e) {
                    e.stopPropagation(), "none" == utils.getStyle(o, "display") && (utils.setStyle(o, {display: "block"}), eventEmitter.emit("channel:showChannel"))
                }), utils.addEvent(i, "mouseout", a), utils.addEvent(s, "mouseout", a)), utils.addEvent(o, "click", function (e) {
                    var t = e.target || e.srcElement;
                    if ("li" == t.nodeName.toLowerCase()) {
                        r.innerHTML = t.innerHTML;
                        var i = document.getElementById("default-channel-nsid"), n = t.getAttribute("data-id");
                        i.value = n
                    }
                }), utils.addEvent(window.document.body, "click", function () {
                    "none" != utils.getStyle(o, "display") && utils.setStyle(o, {display: "none"})
                })
            }
        }, o = function () {
    ...
    znSlideBox.index = function () {
        ...
        var t = function () {
            var e = document, t = e.body, i = e.documentElement,
                n = "BackCompat" == e.compatMode ? t : e.documentElement;
            return Math.max(i.scrollHeight, t.scrollHeight, n.clientHeight)
        }, i = function () {
            function i() {
                var e = parseInt(E), t = 5;
                -89 > e - t && (utils.setStyle(m, {right: e + t + "px"}), window.setTimeout(function () {
                    i()
                }, 1), E = utils.getStyle(m, "right")), utils.setStyle(_, {display: "none"}), utils.setStyle(m, {
                    position: "fixed",
                    top: "150px"
                })
            }
            ...
            function s() {
                var e = parseInt(E), t = 5;
                e >= parseInt(C + 5) && (utils.setStyle(m, {right: e - t + "px"}), window.setTimeout(function () {
                    s()
                }, 1), E = utils.getStyle(m, "right")), e <= parseInt(C + 10) && utils.setStyle(_, {display: "block"})
            }

            function o() {
                var e = parseInt(E), t = 5;
                -89 > e - t && (utils.setStyle(m, {left: e + t + "px"}), window.setTimeout(function () {
                    o()
                }, 1), E = utils.getStyle(m, "left")), utils.setStyle(_, {display: "none"}), utils.setStyle(m, {
                    position: "fixed",
                    top: "150px"
                })
            }
            ...
            function r() {
                var e = parseInt(E), t = 5;
                e >= parseInt(C + 5) && (utils.setStyle(m, {left: e - t + "px"}), window.setTimeout(function () {
                    r()
                }, 1), E = utils.getStyle(m, "left")), e <= parseInt(C + 10) && utils.setStyle(_, {display: "block"})
            }

            var a, l = siteConfig.settings_2.slidingTiming, c = document.getElementById("sliding-search-form-input");
            new Placeholder({inputElem: c, type: "labelFocusEmpty"});
            ...
            var f = parseInt(siteConfig.settings_2.slidingBoxDistance),
                m = document.getElementById("sliding-searchbox"), h = document.getElementById("sliding-box-item"),
                b = parseInt(utils.getStyle(h, "width")), C = (parseInt(b + 158), parseInt(-108 - b));
            bdcsUtils.insertCSS("#sliding-box-item #sliding-search-form-submit{position:relative;left:" + f + "px}", !1, "aaa"), bdcsUtils.insertCSS("#sliding-search-form-input{line-height:" + siteConfig.settings_2.slidingcss["#sliding-box-item input"].height + ";}", !1, "aaa");
            var v = parseInt(b - 20);
            bdcsUtils.insertCSS("#sliding-hot{width:" + v + "px}", !1, "aaa");
            var y = document.getElementById("sliding-search-form-input"), w = parseInt(utils.getStyle(y, "height")),
                x = w;
            ...
            if (siteConfig.settings_2.useChannels && siteConfig.settings_2.customChannel.length > 0 && bdcsUtils.insertCSS("#sliding-box-item input{width:" + (parseInt(siteConfig.settings_2.slidingcss["#sliding-box-item input"].width) - parseInt(siteConfig.settings_2.slidingcss["div#sliding-searchbox  .sliding-channel-meun"].width)) + "px;}"), n(x), 1 == siteConfig.settings_2.slidingPosition) {
                ...
                var _ = document.getElementById("sliding-icon-left"), E = utils.getStyle(m, "right"),
                    S = document.getElementById("sliding-back-right"), I = !1;
                utils.addEvent(_, "mouseover", function () {
                    i(), I = !1
                }), utils.addEvent(S, "click", function (e) {
                    e.stopPropagation(), s()
                }), utils.addEvent(document.getElementById("sliding-searchbox"), "click", function (e) {
                    e.stopPropagation()
                ...
                utils.DOMReady(function () {
                    a = 1 == parseInt(l) ? parseInt(t()) : 2 == parseInt(l) ? parseInt(t() / 2) : 2 * t() / 3, document.addEventListener && document.addEventListener("DOMMouseScroll", k, !1), window.onmousewheel = document.onmousewheel = k
                })
            } else {
                bdcsUtils.insertCSS("#sliding-searchbox{position:fixed;left:" + C + "px;top:150px;}", !1, "aaa");
                var _ = document.getElementById("sliding-icon-right"), E = utils.getStyle(m, "left"),
                    S = document.getElementById("sliding-back"), F = !1;
                utils.addEvent(_, "mouseover", function () {
                    o(), F = !1
                }), utils.addEvent(document.getElementById("sliding-searchbox"), "click", function (e) {
                    e.stopPropagation()
            ...
            if (siteConfig.settings_2.useChannels && siteConfig.settings_2.customChannel.length > 0) {
                ...
                t.length > 0 && document.body.removeChild(t[0]);
                var i = document.createElement("div");
                i.className = "cse-sliding-channel-container", document.body.appendChild(i);
                ...
                i.style.width = siteConfig.settings_2.slidingcss["div#sliding-searchbox  .sliding-channel-meun"].width, eventEmitter.on("channel:showslidingChannel", function () {
                    i.style.left = utils.getElementPos("sliding-channel-meun").x + "px", i.style.top = utils.getElementPos("sliding-channel-meun").y + e + 2 + "px"
                }), bdcsUtils.insertCSS("div#sliding-searchbox .sliding-channel-current i{top:" + (e / 2 - 3) + "px;}"), bdcsUtils.insertCSS("div#sliding-searchbox .sliding-channel-current{height:" + e + "px;line-height:" + e + "px;border-color:" + siteConfig.settings_2.slidingcss["#sliding-box-item input"]["border-color"] + "}", !1, "aaa"), bdcsUtils.insertCSS("div#sliding-searchbox  .sliding-channel-meun{width:" + siteConfig.settings_2.slidingcss["div#sliding-searchbox  .sliding-channel-meun"].width + "}"), "click" == siteConfig.settings_2.channelShowType ? (utils.addEvent(s, "click", function (e) {
                    e.stopPropagation(), "none" == utils.getStyle(o, "display") ? (utils.setStyle(o, {display: "block"}), eventEmitter.emit("channel:showslidingChannel")) : utils.setStyle(o, {display: "none"})
                }), utils.addEvent(window, "scroll", function () {
                    siteConfig.isDemo && utils.setStyle(o, {display: "none"}), "none" == utils.getStyle(o, "display") || siteConfig.isDemo || eventEmitter.emit("channel:showslidingChannel")
                })) : (utils.addEvent(s, "mouseover", function (e) {
                    e.stopPropagation(), "none" == utils.getStyle(o, "display") && (utils.setStyle(o, {display: "block"}), eventEmitter.emit("channel:showslidingChannel"))
                }), utils.addEvent(i, "mouseover", function (e) {
                    e.stopPropagation(), "none" == utils.getStyle(o, "display") && (utils.setStyle(o, {display: "block"}), eventEmitter.emit("channel:showslidingChannel"))
                }), utils.addEvent(i, "mouseout", function (e) {
                    e.stopPropagation(), utils.setStyle(o, {display: "none"})
                }), utils.addEvent(s, "mouseout", function (e) {
                    e.stopPropagation(), utils.setStyle(o, {display: "none"})
                })), utils.addEvent(o, "click", function (e) {
                    e.stopPropagation();
                    var t = e.target || e.srcElement;
                    if ("li" == t.nodeName.toLowerCase()) {
                        r.innerHTML = t.innerHTML;
                        var i = document.getElementById("sliding-channel-nsid"), n = t.getAttribute("data-id");
                        i.value = n, "none" != utils.getStyle(o, "display") && utils.setStyle(o, {display: "none"})
                    }
                }), utils.addEvent(window.document.body, "click", function () {
                    "none" != utils.getStyle(o, "display") && utils.setStyle(o, {display: "none"})
                })
    ...
    znPopupBox.index = function () {
        ...
        var t = function () {
            function e() {
                var t = parseInt(f), i = 5;
                d = parseInt(utils.getStyle(c[0], "height")), t - i >= -5 - d && (utils.setStyle(l, {bottom: t - i + "px"}), window.setTimeout(e, 4), f = utils.getStyle(l, "bottom"), 10 - d >= t && utils.setStyle(m[0], {display: "block"}))
            }

            function t() {
                var e = parseInt(f), i = 5;
                -5 > e - i && (utils.setStyle(l, {bottom: e + i + "px"}), window.setTimeout(t, 4), f = utils.getStyle(l, "bottom")), utils.setStyle(m[0], {display: "none"})
            }

            var s = document.getElementById("popup-search-form-input");
            new Placeholder({inputElem: s, type: "labelFocusEmpty"});
            ...
            var l = document.getElementById("popup-searchbox"), c = utils.getElementsByClassName("popupbox-item"),
                d = parseInt(utils.getStyle(c[0], "height")), u = parseInt(utils.getStyle(c[0], "width")),
                g = utils.getStyle(c[0], "border-color"), p = document.getElementById("popup-back"),
                f = utils.getStyle(l, "bottom"), m = utils.getElementsByClassName("popup-icon"),
                p = document.getElementById("popup-back"), h = document.getElementById("popup-top"),
                b = parseInt(utils.getStyle(h, "height"));
            bdcsUtils.insertCSS("#popup-top{border-bottom-color:" + g + "}", !1, "aaa"), bdcsUtils.insertCSS("#popup-back{border-left-color:" + g + "}", !1, "aaa"), bdcsUtils.insertCSS("#popup-back{color:" + g + "}", !1, "aaa"), utils.setStyle(p, {height: +b + "px"}), utils.setStyle(h, {"line-height": +b + "px"});
            ...
            if (siteConfig.settings_3.useChannels && siteConfig.settings_3.customChannel.length > 0) {
                ...
                t.length > 0 && document.body.removeChild(t[0]);
                var i = document.createElement("div");
                i.className = "cse-popup-channel-container", document.body.appendChild(i);
                ...
                bdcsUtils.insertCSS("div#popup-searchbox .popup-channel-current i{top:" + (e / 2 - 3) + "px;}"), bdcsUtils.insertCSS("div#popup-searchbox .popup-channel-current{height:" + e + "px;line-height:" + e + "px;border-color:" + siteConfig.settings_3.popupcss["#popup-searchbox input"]["border-color"] + "}", !1, "aaa"), bdcsUtils.insertCSS("div#popup-searchbox  .popup-channel-meun{width:" + siteConfig.settings_3.popupcss["div#popup-searchbox  .popup-channel-meun"].width + "}"), i.style.width = siteConfig.settings_3.popupcss["div#popup-searchbox  .popup-channel-meun"].width, eventEmitter.on("channel:showpopupChannel", function () {
                    i.style.left = utils.getElementPos("popup-channel-meun").x + "px", i.style.top = utils.getElementPos("popup-channel-meun").y + e + 2 + "px"
                }), "click" == siteConfig.settings_3.channelShowType ? (utils.addEvent(s, "click", function (e) {
                    e.stopPropagation(), "none" == utils.getStyle(o, "display") ? (utils.setStyle(o, {display: "block"}), eventEmitter.emit("channel:showpopupChannel")) : utils.setStyle(o, {display: "none"})
                }), utils.addEvent(window, "scroll", function () {
                    siteConfig.isDemo && utils.setStyle(o, {display: "none"}), "none" == utils.getStyle(o, "display") || siteConfig.isDemo || eventEmitter.emit("channel:showpopupChannel")
                })) : (utils.addEvent(s, "mouseover", function (e) {
                    e.stopPropagation(), "none" == utils.getStyle(o, "display") && (utils.setStyle(o, {display: "block"}), eventEmitter.emit("channel:showpopupChannel"))
                }), utils.addEvent(i, "mouseover", function (e) {
                    e.stopPropagation(), "none" == utils.getStyle(o, "display") && (utils.setStyle(o, {display: "block"}), eventEmitter.emit("channel:showpopupChannel"))
                }), utils.addEvent(i, "mouseout", function (e) {
                    e.stopPropagation(), utils.setStyle(o, {display: "none"})
                    ...
                    if ("li" == t.nodeName.toLowerCase()) {
                        r.innerHTML = t.innerHTML;
                        var i = document.getElementById("popup-channel-nsid"), n = t.getAttribute("data-id");
                        i.value = n
                    }
                }), utils.addEvent(window.document.body, "click", function () {
                    "none" != utils.getStyle(o, "display") && utils.setStyle(o, {display: "none"})
    ...
    znFloatBox.index = function () {
        ...
        var t = function () {
            ...
            new Placeholder({inputElem: e, type: "labelFocusEmpty"});
            ...
            var r = document.getElementById("float-box-detail"), a = document.getElementById("float-searchbox"),
                l = parseInt(siteConfig.settings_4.topPosition), c = parseInt(utils.getStyle(a, "height")),
            ...
            var g = document.getElementById("float-search-form-input"), p = parseInt(utils.getStyle(g, "width")),
                f = parseInt(utils.getStyle(g, "height")), m = f;
            bdcsUtils.insertCSS("#float-searchbox  #float-search-form-submit{height:" + m + "px;}");
            var h = parseInt(p + u);
            utils.setStyle(r, {width: h + 364 + "px"});
            var b = document.getElementById("float-box");
            utils.setStyle(b, {width: h + 148 + "px"});
            var C = document.getElementById("float-hot");
            C && utils.setStyle(C, {width: p + "px"});
            ...
            switch (utils.addEvent(window, "scroll", function () {
                bdcsUtils.insertCSS("#float-searchbox{position:fixed;width:" + d + "px;}"), bdcsUtils.insertCSS("#float-searchbox{opacity:" + v + ";}");
                var e = document.documentElement.scrollTop || document.body.scrollTop;
                bdcsUtils.insertCSS(1 == siteConfig.settings_4.floatPosition ? "#float-searchbox{position:fixed;bottom:0px;}" : "#float-searchbox{position:fixed;top:0px;}"), 0 == siteConfig.settings_4.floatPosition ? e >= l ? utils.setStyle(a, {visibility: "visible"}) : utils.setStyle(a, {visibility: "hidden"}) : e >= document.body.scrollHeight - document.documentElement.clientHeight - l ? utils.setStyle(a, {visibility: "visible"}) : utils.setStyle(a, {visibility: "hidden"})
            ...
            0 == siteConfig.settings_4.floatPosition && siteConfig.settings_4.useSug && new Sug({
                ...
                boxType: "float",
                offset: {left: siteConfig.settings_4.useChannels ? parseInt(siteConfig.settings_4.floatcss["div#float-searchbox  .float-channel-meun"].width) : 0},
                url: siteConfig.sugUrl || urlConfig.sug,
                param: "wd",
                data: {
            ...
            if (siteConfig.settings_4.useChannels && siteConfig.settings_4.customChannel.length > 0) {
                ...
                t.length > 0 && document.body.removeChild(t[0]);
                var i = document.createElement("div");
                i.className = "cse-float-channel-container", document.body.appendChild(i);
                ...
                bdcsUtils.insertCSS("div#float-searchbox .float-channel-current i{top:" + (e / 2 - 3) + "px;}"), bdcsUtils.insertCSS("div#float-searchbox .float-channel-current{height:" + e + "px;line-height:" + e + "px;border-color:" + siteConfig.settings_4.floatcss["#float-search-form-input"]["border-color"] + "}", !1, "aaa"), bdcsUtils.insertCSS("div#float-searchbox  .float-channel-meun{width:" + siteConfig.settings_4.floatcss["div#float-searchbox  .float-channel-meun"].width + "}"), i.style.width = siteConfig.settings_4.floatcss["div#float-searchbox  .float-channel-meun"].width, eventEmitter.on("channel:showfloatChannel", function () {
                    i.style.left = utils.getElementPos("float-channel-meun").x + "px", i.style.top = utils.getElementPos("float-channel-meun").y + e + 2 + "px"
                }), 1 == siteConfig.settings_4.floatPosition && (bdcsUtils.insertCSS("div.cse-float-channel-container .float-channel-list{overflow:auto;height:62px;}"), bdcsUtils.insertCSS("div.cse-float-channel-container .float-channel-list li{line-height:21px;}")), "click" == siteConfig.settings_4.channelShowType ? (utils.addEvent(s, "click", function (e) {
                    e.stopPropagation(), "none" == utils.getStyle(o, "display") ? (utils.setStyle(o, {display: "block"}), eventEmitter.emit("channel:showfloatChannel")) : utils.setStyle(o, {display: "none"})
                }), utils.addEvent(window, "scroll", function () {
                    siteConfig.isDemo && utils.setStyle(o, {display: "none"}), "none" == utils.getStyle(o, "display") || siteConfig.isDemo || eventEmitter.emit("channel:showfloatChannel")
                })) : (utils.addEvent(s, "mouseover", function (e) {
                    e.stopPropagation(), "none" == utils.getStyle(o, "display") && (utils.setStyle(o, {display: "block"}), eventEmitter.emit("channel:showfloatChannel"))
                }), utils.addEvent(i, "mouseover", function (e) {
                    e.stopPropagation(), "none" == utils.getStyle(o, "display") && (utils.setStyle(o, {display: "block"}), eventEmitter.emit("channel:showfloatChannel"))
                }), utils.addEvent(i, "mouseout", function (e) {
                    e.stopPropagation(), utils.setStyle(o, {display: "none"})
                    ...
                    if ("li" == t.nodeName.toLowerCase()) {
                        r.innerHTML = t.innerHTML;
                        var i = document.getElementById("float-channel-nsid"), n = t.getAttribute("data-id");
                        i.value = n
                    }
                }), utils.addEvent(window.document.body, "click", function () {
                    "none" != utils.getStyle(o, "display") && utils.setStyle(o, {display: "none"})
    ...
    znCustomBox.index = function () {
        var e = function (e, t) {
            ...
            utils.addEvent(e, "submit", function () {
                var e = t.value;
                utils.isEmptyOrSpacing(e) || (log.send(urlConfig.log, pageLog, {
                    search_input_time: window.bdcs.search_input_time,
                    query: encodeURIComponent(e),
            ...
            var e = document.createElement("div");
            e.className = "bdcs-search-custom-sug", e.id = "bdcs-search-custom-sug", e.innerHTML = '<ul class="bdcs-search-custom-sug-list" id="bdcs-search-custom-sug-list"></ul>', document.body.appendChild(e)
        }, n = function (e, t) {
            var i = document.createElement("div");
            i.className = "bdcs-custom-hot", i.id = "bdcs-custom-hot";
            var n = "", s = document.charset || document.characterSet, o = {
                hotWords: t,
                ...
                settings: {inurl: siteConfig.settings_5.inurl},
                isGbk: siteConfig.isGbk || "gbk" == s.toLowerCase() || "gb2312" == s.toLowerCase()
            };
            n = '<%for(var i=0;i < hotNum;i++){%><a href="<%=resultUrl%>?s=<%=siteId%><%= (isGbk ? "&ie=gbk" : "") %>&entry=1&q=<%=window.bdcs.utils.encodeHTML(hotWords[i])%><%= (settings.inurl ? "&inurl="+ window.bdcs.utils.encodeHTML(settings.inurl) : "")%><%= (channelList[0] ? "&cid="+channelList[0] : "")%>" title="<%= window.bdcs.utils.encodeHTML(hotWords[i]) %>" class="bdcs-custom-hot-item"  target="_blank"><%= window.bdcs.utils.encodeHTML(hotWords[i]) %></a><% } %>', i.innerHTML = utils.tmpl(n, o), e.appendChild(i)
        }, s = function () {
            var t = document.getElementById("bdcsMain");
            if (t) {
                var i = e(t, "form");
                if (i) return {input: t, form: i}
            }
            return {input: null, form: null}
        }, o = function (e, t) {
            e.action && -1 != e.action.indexOf("/cse/search") || (e.action = siteConfig.resultUrl), e.method && "get" == e.method.toLowerCase() || (e.method = "get"), "q" != t.name && (t.name = "q");
            var i = "";
            e.elements.s || (i += '<input type="hidden" name="s" value="<%=siteId%>"/>'), e.elements.ie || (i += '<% if(isGbk) { %><input type="hidden" name="ie" value="gbk" /><% } %>'), e.elements.entry || (i += '<input type="hidden" name="entry" value="1" />'), e.elements.cid || (i += '<% if(channelList[0]) {%><input type="hidden" name="cid" value="<%=channelList[0]%>" /><% } %>'), e.elements.inurl || (i += '<% if(settings_5.inurl) {%><input type="hidden" name="inurl" value="<%=settings_5.inurl%>" /><% } %>');
            var n = document.createElement("div");
            n.innerHTML = utils.tmpl(i, siteConfig), e.appendChild(n)
        }, r = function () {
            ...
            if (o(s, n), t(s, n, "custom"), siteConfig.settings_5.useSug) {
                ...
                bdcsUtils.insertCSS(customSugCSS + r, !1), i();
                var a = "";
                ...
                var l = new Sug({
                    ...
                    boxType: "custom",
                    indep: 1,
                    offset: {top: utils.getElementPos("bdcsMain").y, left: utils.getElementPos("bdcsMain").x},
                    url: siteConfig.sugUrl || urlConfig.sug,
                    param: "wd",
                    data: {
                ...
                eventEmitter.on("sug:beforeShowSug", function () {
                    var e = document.getElementById("bdcs-search-custom-sug");
                    e.style.left = utils.getElementPos("bdcsMain").x + "px", e.style.top = utils.getElementPos("bdcsMain").y + l.getInputHeight() + "px"
                })
            }
            return n
        }, a = function (t) {
            if (siteConfig.settings_5.useHot) {
                ...
                for (var r = [], a = [], l = 0; l < t.length; l++) 0 != t[l].charge_info.length && (t = t.slice(l)), 1 != t.length && r.push(t[l].keyword);
                a = siteConfig.settings_5.useCustomHotWords && siteConfig.settings_5.customHotWords.length > 0 ? siteConfig.settings_5.customHotWords.concat(r) : Array.prototype.slice.call(r), n(s, a);
                for (var c = utils.getElementsByClassName("bdcs-custom-hot-item"), l = 0, d = c.length; d > l; l++) utils.addEvent(c[l], "click", function () {
                    var e = this.innerHTML, t = this.parentNode.id;
                    log.send(urlConfig.log, pageLog, {
                        search_input_time: +new Date,
                        query: encodeURIComponent(e),
        ...
        return {init: c, initHot: l, getNode: s}
    }(), siteConfig.recHotWords = [];
    var eventEmitter = new utils.EventEmitter, content = function () {
        function e() {
            FlyJSONP.init(), siteConfig.recHotWords = [];
            var e = "";
            siteConfig.settings.useHot && siteConfig.settings.hotFineWordsEnable ? e = siteConfig.settings.hotFineDetailType : siteConfig.settings_2.useHot && siteConfig.settings_2.hotFineWordsEnable ? e = siteConfig.settings_2.hotFineDetailType : siteConfig.settings_3.useHot && siteConfig.settings_3.hotFineWordsEnable ? e = siteConfig.settings_3.hotFineDetailType : siteConfig.settings_4.useHot && siteConfig.settings_4.hotFineWordsEnable ? e = siteConfig.settings_4.hotFineDetailType : siteConfig.settings_5.useHot && siteConfig.settings_5.hotFineWordsEnable && (e = siteConfig.settings_5.hotFineDetailType), FlyJSONP.get({
                ...
                success: function (e) {
                    e.data && (siteConfig.recHotWords = e.data), i()
                }
            })
        }

        function t(e, t, i, n, s, o) {
            for (var r = [], a = [], l = 0; l < e.length; l++) 0 != e[l].charge_info.length && (e = e.slice(l)), 1 != e.length && a.push(e[l].keyword);
            ...
            s.innerHTML = c;
            for (var g = utils.getElementsByClassName("bdcs-hot-item", s), p = 0, f = g.length; f > p; p++) utils.addEvent(g[p], "click", function () {
                var e = this.innerHTML, t = this.parentNode.id;
                log.send(urlConfig.log, pageLog, {
                    search_input_time: +new Date,
                    query: encodeURIComponent(e),
        ...
        function i() {
            var e = document.getElementById("bdcs"), t = /^https?:\/\//;
            if (!e) return null;
            if (!(siteConfig && siteConfig.settings && "isGbk" in siteConfig) || siteConfig.isHideAll) return "";
            n();
            var i = 0;
            siteConfig.settings.useSetting ? siteConfig.settings.cseUrl ? siteConfig.resultUrl = siteConfig.settings.cseUrl : i = 1 : siteConfig.settings_2.useSliding ? siteConfig.settings_2.cseUrl ? siteConfig.resultUrl = siteConfig.settings_2.cseUrl : i = 1 : siteConfig.settings_3.usePopup ? siteConfig.settings_3.cseUrl ? siteConfig.resultUrl = siteConfig.settings_3.cseUrl : i = 1 : siteConfig.settings_4.useFloat ? siteConfig.settings_4.cseUrl ? siteConfig.resultUrl = siteConfig.settings_4.cseUrl : i = 1 : siteConfig.settings_5.useCustom && (siteConfig.settings_5.cseUrl ? siteConfig.resultUrl = siteConfig.settings_5.cseUrl : i = 1), 1 === i && (siteConfig.isDemo && (siteConfig.isGbk = !1, siteConfig.resultUrl = "zhannei.baidu.com/"), siteConfig.resultUrl = siteConfig.resultUrl || "zhannei.baidu.com", -1 == siteConfig.resultUrl.indexOf("cse/search") && (siteConfig.resultUrl += "/" !== siteConfig.resultUrl.charAt(siteConfig.resultUrl.length - 1) ? "/cse/search" : "cse/search")), t.test(siteConfig.resultUrl) || (siteConfig.resultUrl = "http://" + siteConfig.resultUrl), siteConfig.resultTarget = "_blank";
            ...
            a.className = "bdcs-container", e.appendChild(a), a.innerHTML = utils.tmpl(bdcsTpl, siteConfig), o(), siteConfig.settings.useSetting && siteConfig.settings.useZone ? new Zone({
                formElem: document.getElementById("bdcs-search-form"),
                inputElem: document.getElementById("bdcs-search-form-input")
            ...
            }), znDefultBox.index.init(), znSlideBox.index.init(), znPopupBox.index.init(), znFloatBox.index.init(), znCustomBox.index.init();
            ...
            if (l && c) {
                ...
                utils.setStyle(c, {height: d, lineHeight: d})
            }
            return log.send(urlConfig.ping, pageLog, {plate_url: siteConfig.locationUrl || window.location.href}), e
        }

        function n() {
            var e = document.getElementById("bdcs"), t = utils.getElementsByClassName("bdcs-container")[0];
            e && t && e.removeChild(t), bdcsUtils.removeCSS()
        }
        ...
        function o() {
            var e;
            siteConfig.settings.useSetting && siteConfig.settings.useHot && (e = "", siteConfig.settings.hotFineWordsEnable && (e = siteConfig.settings.hotFineDetailType), s(1, e, siteConfig.settings.hotNum)), siteConfig.settings_2.useSliding && siteConfig.settings_2.useHot && (e = "", siteConfig.settings_2.hotFineWordsEnable && (e = siteConfig.settings_2.hotFineDetailType), s(2, e, siteConfig.settings_2.hotNum)), siteConfig.settings_3.usePopup && siteConfig.settings_3.useHot && (e = "", siteConfig.settings_3.hotFineWordsEnable && (e = siteConfig.settings_3.hotFineDetailType), s(3, e, siteConfig.settings_3.hotNum)), siteConfig.settings_4.useFloat && siteConfig.settings_4.useHot && (e = "", siteConfig.settings_4.hotFineWordsEnable && (e = siteConfig.settings_4.hotFineDetailType), s(4, e, siteConfig.settings_4.hotNum)), siteConfig.settings_5.useCustom && siteConfig.settings_5.useHot && (e = "", siteConfig.settings.hotFineWordsEnable && (e = siteConfig.settings_5.hotFineDetailType), s(5, e, siteConfig.settings_5.hotNum))
        }

        return {create: i, dispose: n, getFineHot: e}
    }();
    "_bdcs" in window && window._bdcs.siteConfig && (siteConfig = utils.extendDeep(siteConfig, window._bdcs.siteConfig)), FlyJSONP.init(), null == content.create() && utils.DOMReady(function () {
        content.create()
    }), !function () {
        function replaceWord(elem, wordObject) {
            for (var words = wordObject.word, n = 0, nLen = words.length; nLen > n; n++) {
                var eword, flag = 1;
                eval("eword = " + words[n] + ";");
                for (var word = eword.entity, m = 0; m < replaceBan.length; m++) word === replaceBan[m] && (flag = 0);
                if (!(successWords.length >= replaceNum || 0 === flag)) {
                    for (var link = wordObject.link, wordRegex = new RegExp(word), wordRegexGlobal = new RegExp(word, "g"), matchNum, textNodes = utils.getTextNodes(elem), textNode, validTextNodes = [], parentNode, hook_1 = document.getElementById("bdcs"), hook_2 = document.getElementById("bdcs-rec"), hookParent = hook_1 && hook_2 && hook_1.parentNode && hook_2.parentNode, i = 0, iLen = textNodes.length; iLen > i; i++) textNodes[i].nodeValue.indexOf(word) > -1 && validTextNodes.push(textNodes[i]);
                    for (var i = 0, iLen = validTextNodes.length; iLen > i; i++) {
                        ...
                        try {
                            if (parentNode = textNode.parentNode, textNode.parentNode.parentNode) {
                                ...
                                if (-1 !== utils.indexOf(forbiddenLinkWrapper2, parentNode2.nodeName.toLowerCase()) && (isForbidden = 1), parentNode2.parentNode) {
                                    ...
                                    -1 !== utils.indexOf(forbiddenLinkWrapper2, parentNode3.nodeName.toLowerCase()) && (isForbidden = 1)
                                }
                            }
                            matchNum = textNode.nodeValue.match(wordRegexGlobal) ? textNode.nodeValue.match(wordRegexGlobal).length : 0;
                            for (var j = 0; matchNum > j; j++) wordsStatus[word] = wordsStatus[word] || 0, textNode && parentNode && -1 === utils.indexOf(forbiddenLinkWrapper, parentNode.nodeName.toLowerCase()) && hookParent !== parentNode && word && void 0 != wordsStatus[word] && wordsStatus[word] < replaceLimit && 0 === isForbidden ? (wordsStatus[word]++, textNode.nodeValue = textNode.nodeValue.replace(wordRegex, safeWord), successWords.push(word)) : failWords.push(word);
        ...
        var inlineLinkElems, wordsStatus = {}, replaceLimit = 1, replaceNum = 10, replaceBan = [], currentNum = 0,
            safeWord = "PUSDVJ_BAIDURP_38707944", safeWordRegex = new RegExp(safeWord, "g"), successWords = [],
            failWords = [];
        siteConfig.settings.useInline ? (replaceLimit = 0 === siteConfig.settings.inlineLimit ? 100 : siteConfig.settings.inlineLimit, replaceNum = siteConfig.settings.inlineNum ? siteConfig.settings.inlineNum : 10, replaceBan = siteConfig.settings.inlineBan.length > 0 ? siteConfig.settings.inlineBan : []) : siteConfig.settings_2.useInline ? (replaceLimit = 0 === siteConfig.settings_2.inlineLimit ? 100 : siteConfig.settings_2.inlineLimit, replaceNum = siteConfig.settings_2.inlineNum ? siteConfig.settings_2.inlineNum : 10, replaceBan = siteConfig.settings_2.inlineBan.length > 0 ? siteConfig.settings_2.inlineBan : []) : siteConfig.settings_3.useInline ? (replaceLimit = 0 === siteConfig.settings_3.inlineLimit ? 100 : siteConfig.settings_3.inlineLimit, replaceNum = siteConfig.settings_3.inlineNum ? siteConfig.settings_3.inlineNum : 10, replaceBan = siteConfig.settings_3.inlineBan.length > 0 ? siteConfig.settings_3.inlineBan : []) : siteConfig.settings_4.useInline ? (replaceLimit = 0 === siteConfig.settings_4.inlineLimit ? 100 : siteConfig.settings_4.inlineLimit, replaceNum = siteConfig.settings_4.inlineNum ? siteConfig.settings_4.inlineNum : 10, replaceBan = siteConfig.settings_4.inlineBan.length > 0 ? siteConfig.settings_4.inlineBan : []) : siteConfig.settings_5.useInline && (replaceLimit = 0 === siteConfig.settings_5.inlineLimit ? 100 : siteConfig.settings_5.inlineLimit, replaceNum = siteConfig.settings_5.inlineNum ? siteConfig.settings_5.inlineNum : 10, replaceBan = siteConfig.settings_5.inlineBan.length > 0 ? siteConfig.settings_5.inlineBan : []), utils.DOMReady(function () {
            ...
            o && t && utils.loadScript(urlConfig.xpathJS, function () {
                wgxpath.install(), FlyJSONP.get({
                    url: siteConfig.link || urlConfig.link,
                    parameters: {uid: siteConfig.locationUrl || window.location.href},
                    success: function (e) {
                        var t, i, n, s, o = e.word, r = {};
                        if (o && 0 === e.errno) {
                            ...
                            c && l && (siteConfig.resultUrl = "", siteConfig.resultTarget = "_self"), "4195211300598999376" == siteConfig.siteId && (siteConfig.resultUrl = "http://so.39.net/cse/search");
                            var d = siteConfig.resultUrl + "?s=" + siteConfig.siteId + "&entry=1";
                            siteConfig.channelList && siteConfig.channelList[0] && (d += "&cid=" + siteConfig.channelList[0]), siteConfig.settings.useSetting && siteConfig.settings.inurl && (d += "&inurl=" + siteConfig.settings.inurl);
                            for (var u = 0, g = o.length; g > u; u++) t = o[u].xpath, r[t] = r[t] || [], r[t].push({
                                word: o[u].entity_list || [],
                                link: d
                            });
                            for (i in r) {
                                n = document.evaluate(i, document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
                                for (var p = 0, f = n.snapshotLength; f > p; p++) s = n.snapshotItem(p), replaceWord(s, r[i][0])
                            }
                            log.send(urlConfig.log, pageLog, {
                                log_type: "inline",
                                site_id: siteConfig.siteId,
                            ...
                            for (var p = 0, f = inlineLinkElems.length; f > p; p++) utils.addEvent(inlineLinkElems[p], "click", function () {
                                log.send(urlConfig.log, pageLog, {
    ...
    var Tooltip = function () {
        ...
        function i(e, t) {
            ...
            n && n[0].appendChild(i), i.styleSheet ? i.styleSheet.cssText = e : i.appendChild(document.createTextNode(e))
        }
        ...
        function o(e, t) {
            var i, o, r = t;
            if ("string" == typeof t && (r = r.split(" ")), 1 === e.nodeType && e.className) for (var a = 0, l = r.length; l > a; a++) i = r[a], o = new RegExp("\\b(" + i + ")\\b"), o.test(e.className) && (e.className = e.className.replace(o, " "));
            e.className = n(e.className) || "", e.className = s(e.className) || ""
        }
        ...
        function r(e) {
            ...
            this.options = t(i, e || {}), this.render(this.options.data)
        }

        var a = document.createElement("div");
        return r.prototype.locate = function (e, t) {
            var i = this;
            refer = e, option = i.options || {};
            var n = (option.container, option.position);
            a.style.visibility = "hidden", a.style.position = "absolute", a.style.display = "block";
            var s = option.gap || option.GAP, r = option.arrowHook, l = option.arrowInner;
            sLeft = 0 == document.documentElement.scrollLeft ? document.body.scrollLeft : document.documentElement.scrollLeft, sTop = 0 == document.documentElement.scrollTop ? document.body.scrollTop : document.documentElement.scrollTop, window.innerWidth ? winWidth = window.innerWidth : document.body && document.body.clientWidth && (winWidth = document.body.clientWidth), window.innerHeight ? winHeight = window.innerHeight : document.body && document.body.clientHeight && (winHeight = document.documentElement.clientHeight);
            var c = sTop, d = sLeft;
            if (refer.offsetWidth > 400) var u = e.innerHTML.length + refer.offsetHeight / 2,
                g = refer.offsetHeight / 2, p = t.clientX + sLeft - 20,
                f = t.clientY + sTop - 20; else var u = refer.offsetWidth, g = refer.offsetHeight,
                m = refer.getBoundingClientRect(), f = m.top + sTop, p = m.left + sLeft;
            var h = a.offsetWidth, b = a.offsetHeight, C = r.offsetWidth, v = r.offsetHeight / 2;
            a.style.display = "none", a.style.visibility = "visible";
            var y = {}, w = {};
            if (y = {
                top: null,
                left: null,
                ...
                arrowPos: null,
                arrowLeft: null
            }, y.top = f - s - b - v, y.arrowPos = "bottom", y.left = p + (u - h), y.arrowLeft = p + u - C / 2, w.toprr = y, n && w[n]) y = w[n]; else {
                var x, _, E, S;
                for (x in w) y = w[x], _ = this.calculateArea(c, d, winWidth, winHeight, y.top, y.left, h, b), _ = _.area, (!S || _ > E) && (S = x, E = _);
                y = w[S]
            }
            null !== y.arrowLeft && (y.left > y.arrowLeft && (y.arrowLeft = y.left + C), y.arrowLeft + C > y.left + h && (y.arrowLeft = y.left + h - 3 * C)), null !== y.arrowLeft && (y.arrowLeft = y.arrowLeft - y.left), a.style.top = y.top + "px", a.style.left = y.left + "px", o(r, option.arrowClass.top), o(l, option.arrowClass.innertop), o(r, option.arrowClass.bottom), o(l, option.arrowClass.innerbottom), this.options.arrowPosition = y.arrowPos, this.posArrow();
            var I = y.arrowLeft || "";
            "" == I ? (r.style.left = "", l.style.left = "") : (r.style.left = I + "px", l.style.left = I + "px"), r.style.zIndex = "2", l.style.zIndex = "3"
        }, r.prototype.calculateArea = function (e, t, i, n, s, o, r, a) {
            var l = s > e ? s : e, c = o > t ? o : t, d = e + n > s + a ? s + a : e + n,
                u = t + i > o + r ? o + r : t + i;
            return {area: (u - c) * (d - l)}
            ...
            switch (t.arrowPosition) {
                case"top":
                    t.arrowHook.className += " arrow-top", t.arrowInner.className += " arrowinner-top";
                    break;
                case"bottom":
                    t.arrowHook.className += " arrow-bottom", t.arrowInner.className += " arrowinner-bottom"
            }
        }, r.prototype.pop = function (e, t) {
            var i = this;
            i.locate(e, t)
        }, r.prototype.setData = function (e, t) {
            for (var i = this, n = i.options, s = 0, o = e.length; o > s; s++) for (var r = 0, a = t.length; a > r; r++) e[s].innerHTML == t[r].name && e[s].getAttribute("data-offset") == t[r].offset && e[s].getAttribute("data-xpath") == t[r].xpath && (n.triggerData.push(t[r]), i.setTargetData(e[s], s))
        }, r.prototype.setTargetData = function (e, t) {
            e.setAttribute("data-index", t)
        }, r.prototype.setTargetCSS = function () {
            i(".bdcs-inlineAdvlink{color:#1e0fbe;}"), i(".bdcs-tooltip-panel{box-shadow: 0px 0px 10px #c9c7c7;-moz-box-shadow: 0px 0px 10px #c9c7c7;-webkit-box-shadow: 0px 0px 10px #c9c7c7;background-color: white;border: 1px solid #D9D9D9;color: inherit;display:none;z-index:200000000;line-height: normal;_zoom: 1;}")
        }, r.prototype.setArrowCSS = function () {
            var e = this, t = e.options;
            t.arrowHook = document.createElement("i"), t.arrowInner = document.createElement("i"), t.arrowHook.innerHTML = "&#9670;", t.arrowInner.innerHTML = "&#9670;", a.appendChild(t.arrowHook), a.appendChild(t.arrowInner), i('.bdcs-tooltip-arrow, .bdcs-tooltip-arrowinner{position: absolute;font: 400 14px/18px "宋体";width: 14px;overflow: hidden;}'), i(".arrow-top{top: -9px;color:#D9D9D9;}"), i(".arrowinner-top{top: -8px;color:#fff;}"), i(".arrow-bottom{bottom: -11px;color:#D9D9D9;}"), i(".arrowinner-bottom{bottom: -9px;color:#fff;}"), t.arrowHook.className = "bdcs-tooltip-arrow", t.arrowInner.className = "bdcs-tooltip-arrowinner"
        }, r.prototype.setContent = function () {
            var e = this;
            e.options, document.body.appendChild(a);
            var t = document.createElement("iframe");
            return t.width = 326, t.height = 214, t.frameborder = "0", t.setAttribute("frameborder", "0", 0), t.scrolling = "no", a.appendChild(t), a.className = "bdcs-tooltip-panel", a.id = "bdcs-tooltip-panel", {iframe: t}
        }, r.prototype.render = function (t) {
            var i = this, n = i.options, s = n.trigger, o = i.setContent();
            i.setData(s, t), i.setArrowCSS(), i.setTargetCSS();
            for (var r = 0, l = s.length; l > r; r++) e(s[r], "mouseover", function (e) {
                var t = e.target || e.srcElement;
                ...
                o.iframe.src = s, i.pop(t, e), a.style.display = "block"
            }), e(s[r], "mouseout", function () {
                a.setAttribute(n.disappearTimerAttr, setTimeout(function () {
                    a.style.display = "none", o.iframe.src = ""
                }, n.disappearDelay))
            }), e(a, "mouseover", function () {
                a.style.display = "block", clearTimeout(a.getAttribute(n.disappearTimerAttr))
    ...
    !function () {
        function e(e, t) {
            for (var n = t, g = 0, p = n.length; p > g; g++) {
                ...
                if (!(l.length >= r || 0 === S)) {
                    ...
                    for (var T = 0, N = E.length; N > T; T++) {
                        m = E[T];
                        try {
                            h = m.parentNode, f = m.nodeValue.match(x) ? m.nodeValue.match(x).length : 0;
                            for (var L = 0; f > L; L++) s[b] = s[b] || 0, m && h && -1 === utils.indexOf(i, h.nodeName.toLowerCase()) && F !== h && b && void 0 != s[b] && s[b] < o ? (s[b]++, m.nodeValue = m.nodeValue.replace(w, d), l.push(b)) : c.push(b);
                            (N > T + 1 && E[T + 1].parentNode != h || T + 1 == N && F !== h) && (h.innerHTML = h.innerHTML.replace(u, '<a href="javascript:void();" class="bdcs-inlinecard" data-offset="' + C + '" data-entity="' + encodeURIComponent(v) + '" data-baike="' + y + '">' + b + "</a>"))
                        } catch (B) {
        ...
        urlConfig.xpathJS = urlConfig.urlRoot + "static/customer-search/js/wgxpath.install.js", urlConfig.inlineCardLink = urlConfig.urlRoot + "customer_search/api/card";
        var n, s = {}, o = 1, r = 20, a = [], l = [], c = [], d = "PUSDVJ_BAIDURP_38707944", u = new RegExp(d, "g");
        siteConfig.settings.useInline ? (o = 0 === siteConfig.settings.inlineLimit ? 100 : siteConfig.settings.inlineLimit, r = siteConfig.settings.inlineNum ? siteConfig.settings.inlineNum : 20, a = siteConfig.settings.inlineBan.length > 0 ? siteConfig.settings.inlineBan : []) : siteConfig.settings_2.useInline ? (o = 0 === siteConfig.settings_2.inlineLimit ? 100 : siteConfig.settings_2.inlineLimit, r = siteConfig.settings_2.inlineNum ? siteConfig.settings_2.inlineNum : 20, a = siteConfig.settings_2.inlineBan.length > 0 ? siteConfig.settings_2.inlineBan : []) : siteConfig.settings_3.useInline ? (o = 0 === siteConfig.settings_3.inlineLimit ? 100 : siteConfig.settings_3.inlineLimit, r = siteConfig.settings_3.inlineNum ? siteConfig.settings_3.inlineNum : 20, a = siteConfig.settings_3.inlineBan.length > 0 ? siteConfig.settings_3.inlineBan : []) : siteConfig.settings_4.useInline ? (o = 0 === siteConfig.settings_4.inlineLimit ? 100 : siteConfig.settings_4.inlineLimit, r = siteConfig.settings_4.inlineNum ? siteConfig.settings_4.inlineNum : 20, a = siteConfig.settings_4.inlineBan.length > 0 ? siteConfig.settings_4.inlineBan : []) : siteConfig.settings_5.useInline && (o = 0 === siteConfig.settings_5.inlineLimit ? 100 : siteConfig.settings_5.inlineLimit, r = siteConfig.settings_5.inlineNum ? siteConfig.settings_5.inlineNum : 20, a = siteConfig.settings_5.inlineBan.length > 0 ? siteConfig.settings_5.inlineBan : []), utils.DOMReady(function () {
            for (var i = siteConfig.inlineSites || t, s = 0, o = i.length; o > s; s++) if (window.location.href.indexOf(i[s]) >= 0) {
                utils.loadScript(urlConfig.xpathJS, function () {
                    wgxpath.install(), FlyJSONP.get({
                        ...
                        success: function (t) {
                            var i, s, o, r, a = t.result.res, d = {};
                            if (a.length) {
                                bdcsUtils.insertCSS("a.bdcs-inlinecard{cursor:default;color:#136EC2}a.bdcs-inlinecard:hover{color:#0050c8;}", !1);
                                for (var u = 0, g = a.length; g > u; u++) i = a[u].xpath, d[i] = d[i] || [], d[i].push({
                                    name: a[u].name,
                                    offset: a[u].offset,
                                    baike: a[u].baikeID,
                                    entity: a[u].ret_value
                                });
                                for (s in d) for (var o = document.evaluate(s, document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null), p = 0, f = o.snapshotLength; f > p; p++) r = o.snapshotItem(p), e(r, d[s]);
                                n = utils.getElementsByClassName("bdcs-inlinecard");
                                for (var p = 0, f = n.length; f > p; p++) utils.addEvent(n[p], "mouseover", function () {
                                    log.send(urlConfig.log, pageLog, {
    ...
    !function () {
        ...
        function create(wordObject) {
            ...
            if (bdcsRecCard) {
                ...
                var list = document.getElementById("bdcsRecCardList"),
                    title = document.getElementById("bdcsRecCardTitle"), item = "", baike = wordObject.baikeID,
                    value = eval("(" + wordObject.ret_value + ")"), leftEntity = value[baike].left_entity,
                    midEntity = value[baike].mid_entity;
                title.innerHTML = midEntity.name + "和" + leftEntity.name + "之间的那些事";
                for (var lefttags = leftEntity.TAG, i = 0; i < lefttags.length; i++) {
        ...
        var inlineLinkElems;
        utils.DOMReady(function () {
            for (var e = siteConfig.inlineSites || recLinkSites, t = 0, i = e.length; i > t; t++) if (window.location.href.indexOf(e[t]) >= 0) {
                FlyJSONP.get({
                    ...
                    success: function (e) {
                        var t = e.result.res, i = 0, n = null, s = document.getElementById("bdcsRecCard");
                        if (s) {
                            if (!t.length) {
                                var s = document.getElementById("bdcsRecCard");
                                return s && (s.style.display = "none"), void log.send(urlConfig.log, pageLog, {
                            ...
                            i = getRandomSize(0, t.length - 1), n = t[i], create(n), inlineLinkElems = utils.getElementsByClassName("rec-card-list-item"), num_val = [];
                            for (var o = 0, r = inlineLinkElems.length; r > o; o++) utils.addEvent(inlineLinkElems[o], "click", function (e) {
                                var t = e.target || e.srcElement;
                                log.send(urlConfig.log, pageLog, {
    ...
    var searchRmd = function () {
        ...
        function _addClass(e, t) {
            var i, n, s = t;
            if ("string" == typeof t && (s = s.split(" ")), 1 === e.nodeType) if (e.className || 1 !== s.length) for (var o = 0, r = s.length; r > o; o++) i = s[o], n = new RegExp("\\b(" + i + ")\\b"), n.test(e.className) || (e.className = e.className + " " + i); else e.className = s[0];
            e.className = _trim(e.className), e.className = _clearMultiSpace(e.className)
        }
        ...
        function create(recData, useConfig, useCss, recWords, totleWords) {
            ...
            if (!recData || !recData.wordinfo || recData.wordinfo && recData.wordinfo.length < useConfig.minNum && 2 == useConfig.minShow) bdcsUtils.insertCSS("#bdcs-rec{display:none;}", !1, "aaa"); else {
                if ((6 == parseInt(useConfig.recTemple) || 7 == parseInt(useConfig.recTemple)) && 0 == recData.picinfo.length) return;
                flDispose(), dispose(), bdcsUtils.insertCSS("#bdcs-rec{display:block;}", !1, "aaa");
                var searchRec = document.getElementById("bdcs-rec");
                if (!searchRec) return;
                var bdcsRecContainerElem = document.createElement("div");
                bdcsRecContainerElem.className = "bdcs-rec-container", searchRec.appendChild(bdcsRecContainerElem), bdcsRecContainerElem.innerHTML = utils.tmpl(searchTpl, useConfig);
                var showRecNums = 0;
                ...
                for (var i = 0; showRecNums > i; i++) {
                    ...
                    bdcsRecDetailItem.className = "bdcs-rec-detail-item", bdcsRecDetailContent.appendChild(bdcsRecDetailItem), bdcsRecDetailItem = utils.getElementsByClassName("bdcs-rec-detail-item");
                    var bdcsRecClearDn = document.createElement("li");
                    bdcsRecClearDn.className = "bdcs-rec-clear-dn", bdcsRecDetailContent.appendChild(bdcsRecClearDn)
                }
                ...
                if (1 == useConfig.recTitlePosition) {
                    ...
                    bdcsUtils.insertCSS(".bdcs-rec-title{float:left;} .bdcs-rec-detail{position:relative;left:30px;width:" + recDetailWidth + "px;}", !1, "aaa"), "down" === useConfig.recType && bdcsUtils.insertCSS(".bdcs-rec-title{float:left;} .bdcs-rec-detail{float:left;position:relative;left:30px;width:" + recDetailWidth + "px;}", !1, "aaa")
                }
                ...
                siteConfig.isGbk && (link += "&ie=gbk"), siteConfig.channelList[0] && (link += "&cid=" + siteConfig.channelList[0]), siteConfig.settings.useSetting && siteConfig.settings.inurl && (link += "&inurl=" + siteConfig.settings.inurl);
                for (var i = 0; i < bdcsRecDetailItem.length; i++) {
                    var currentItem = bdcsRecDetailItem[i];
                    _addClass(currentItem, "bdcs-rec-detail-item" + i), bdcsUtils.insertCSS("#bdcs-rec .bdcs-rec-three .bdcs-rec-detail-item" + i + "{background-color:" + getRandomColor(i) + "} #bdcs-rec .bdcs-rec-five .bdcs-rec-detail-item" + i + " a{color:" + getRandomColor(i) + ";font-size:" + getRandomSize(14, 24) + "px}", !1, "aaa"), 1 == getRandomWeight() && bdcsUtils.insertCSS("#bdcs-rec .bdcs-rec-five .bdcs-rec-detail-item" + i + " a{font-weight:bold}", !1, "aaa");
                    ...
                    if (bdcsRecDetailItemHref.setAttribute("href", link + "&q=" + encodeURIComponent(str)), bdcsRecDetailItemHref.setAttribute("target", siteConfig.resultTarget), "cross" === useConfig.recType && (6 == parseInt(useConfig.recTemple) || 7 == parseInt(useConfig.recTemple)) && recData.picinfo.length > 0) {
                        if (recData.picinfo[i]) {
                            ...
                            iframe.src = (siteConfig.znsvUrl || urlConfig.urlRoot) + "static/customer-search/html/recImg.html?img=" + encodeURIComponent(recData.picinfo[i]) + "&w=75&alink=" + encodeURIComponent(link + "&q=" + encodeURIComponent(str)), iframe.width = 75, iframe.height = 75, iframe.frameborder = "0", iframe.setAttribute("frameborder", "0", 0), iframe.scrolling = "no", iframe.onload = function () {
                            }, bdcsRecDetailItemHref.appendChild(iframe), bdcsRecDetailItem[i].appendChild(bdcsRecDetailItemHref)
                        }
                    } else bdcsRecDetailItemHref.innerHTML = decodeURIComponent(str), bdcsRecDetailItem[i].appendChild(bdcsRecDetailItemHref);
                    utils.addEvent(currentItem, "click", function () {
        ...
        function dispose() {
            ...
            e && e.firstChild && e.removeChild(e.firstChild), bdcsUtils.removeCSS()
        }
        ...
        function flCreate(recData, useConfig, useCss, recWords, totleWords) {
            if (recData && recData.wordinfo && recData.wordinfo.length > 0) {
                ...
                dispose(), flDispose();
                var flRecElem = document.createElement("div"), bdcsElem = document.getElementById("bdcs");
                flRecElem.className = "bdcs-rec-float-container", flRecElem.id = "bdcsFlRec", document.body.appendChild(flRecElem), "" === useConfig.recTitleContent && (useConfig.recTitleContent = "为您推荐"), flRecElem.innerHTML = utils.tmpl(searchTpl, useConfig);
                var customCSS = utils.convertJSON2CSS(useCss);
                2 == parseInt(useConfig.recTemple) ? bdcsUtils.insertCSS(floatRecCSS1 + customCSS, !1, "aaa") : 3 == parseInt(useConfig.recTemple) ? bdcsUtils.insertCSS(floatRecCSSPic + customCSS, !1, "aaa") : bdcsUtils.insertCSS(floatRecCSS + customCSS, !1, "aaa"), siteConfig.settings_5.useCustom || (siteConfig.settings.useChannels && siteConfig.settings.customChannel.length > 0 && bdcsUtils.insertCSS(".bdcs-search-form-input{width:" + (parseInt(siteConfig.settings.css[".bdcs-search-form-input"].width) - parseInt(siteConfig.settings.css["div#default-searchbox  .default-channel-meun"].width)) + "px;}"), siteConfig.settings_2.useChannels && siteConfig.settings_2.customChannel.length > 0 && bdcsUtils.insertCSS("#sliding-box-item input{width:" + (parseInt(siteConfig.settings_2.slidingcss["#sliding-box-item input"].width) - parseInt(siteConfig.settings_2.slidingcss["div#sliding-searchbox  .sliding-channel-meun"].width)) + "px;}"), siteConfig.settings_3.useChannels && siteConfig.settings_3.customChannel.length > 0 && bdcsUtils.insertCSS("#popup-searchbox input{width:" + (parseInt(siteConfig.settings_3.popupcss["#popup-searchbox input"].width) - parseInt(siteConfig.settings_3.popupcss["div#popup-searchbox  .popup-channel-meun"].width)) + "px;}"), siteConfig.settings_4.useChannels && siteConfig.settings_4.customChannel.length > 0 && bdcsUtils.insertCSS("#float-search-form-input{width:" + (parseInt(siteConfig.settings_4.floatcss["#float-search-form-input"].width) - parseInt(siteConfig.settings_4.floatcss["div#float-searchbox  .float-channel-meun"].width)) + "px;}"));
                ...
                frameElem && frameFlag && (siteConfig.resultUrl = "", siteConfig.resultTarget = "_self");
                var link = siteConfig.resultUrl + "?s=" + siteConfig.siteId + "&entry=1";
                siteConfig.isGbk && (link += "&ie=gbk"), siteConfig.channelList && siteConfig.channelList[0] && (link += "&cid=" + siteConfig.channelList[0]), siteConfig.settings.useSetting && siteConfig.settings.inurl && (link += "&inurl=" + siteConfig.settings.inurl);
                for (var i = 0; i < recData.wordinfo.length; i++) {
                    var flRecLink = document.createElement("a"), str = eval("'" + recData.wordinfo[i] + "'");
                    flRecLink.target = siteConfig.resultTarget, flRecLink.href = link + "&q=" + encodeURIComponent(str);
                    ...
                    if (flRecWord.className = "bdcs-rec-float-item", 3 == parseInt(useConfig.recTemple)) {
                        if (recData.picinfo.length > 0 && recData.picinfo[i]) {
                            ...
                            var iframe = document.createElement("iframe");
                            iframe.src = (siteConfig.znsvUrl || urlConfig.urlRoot) + "static/customer-search/html/recImg.html?img=" + encodeURIComponent(recData.picinfo[i]) + "&w=40&alink=" + encodeURIComponent(link + "&q=" + encodeURIComponent(str)) + "&curl=" + encodeURIComponent(window.location.host), iframe.width = 40, iframe.height = 40, iframe.frameborder = "0", iframe.setAttribute("frameborder", "0", 0), iframe.scrolling = "no", flRecWord.appendChild(iframe)
                        }
                    } else flRecWord.innerHTML = decodeURIComponent(str);
                    flRecLink.appendChild(flRecWord), flRecList.appendChild(flRecLink), utils.addEvent(flRecWord, "click", function () {
                        var e, t = this.innerText;
                        log.send(urlConfig.log, e, {
                            query: encodeURIComponent(t),
                ...
                }), utils.addEvent(flRecIcon, "click", function () {
        ...
        function flDispose() {
            ...
            e && document.body.removeChild(e), bdcsUtils.removeCSS()
        }

        return {create: create, dispose: dispose, flCreate: flCreate, flDispose: flDispose}
    }();
    bdcsUtils.insertCSS("#bdcs-rec{display:none;}", !1, "aaa"), FlyJSONP.init();
    var searchRmdAll = function () {
        function create() {
            var useConfig = [], useCss = [], hotFineDetailType = "";
            siteConfig.settings.useRecommand ? (useConfig = siteConfig.settings, useCss = siteConfig.settings.css) : siteConfig.settings_2.useRecommand ? (useConfig = siteConfig.settings_2, useCss = siteConfig.settings_2.slidingcss) : siteConfig.settings_3.useRecommand ? (useConfig = siteConfig.settings_3, useCss = siteConfig.settings_3.popupcss) : siteConfig.settings_4.useRecommand ? (useConfig = siteConfig.settings_4, useCss = siteConfig.settings_4.floatcss) : siteConfig.settings_5.useRecommand && (useConfig = siteConfig.settings_5, useCss = siteConfig.settings_5.customcss), siteConfig.settings.useHot && siteConfig.settings.hotFineWordsEnable && (hotFineDetailType = siteConfig.settings.hotFineDetailType);
                ...
                FlyJSONP.get({
                    ...
                    success: function (data) {
                        ...
                        if (data && 0 == data.errno && (recData = data, recData && recData.wordinfo)) {
                            ...
                            recData.wordinfo = returnInfo, recData.picinfo = returnImg, recWords = returnInfo, recLength = recData.wordinfo.length
                        }
                        ...
                        } else totleWords = recData.wordinfo, 2 === useConfig.recShowType || "2" === useConfig.recShowType ? searchRmd.flCreate(recData, useConfig, useCss, recWords, totleWords) : searchRmd.create(recData, useConfig, useCss, recWords, totleWords)
                    }
                })
            }
        }
    ...
    var Card = function () {
        function e(t) {
            var i = document.getElementById("bdcsWnCard"), o = parseInt(utils.getStyle(i, "left"), 10);
            if (0 > o) window.bdcsMncardReady = 0, i.style.left = o + 4 + "px", window.setTimeout(function () {
                e(t)
            }, 1); else {
                window.bdcsMncardReady = 1, n = 1, s = 0;
                var r;
        ...
        function t() {
            var e = document.getElementById("bdcsWnCard"), i = parseInt(utils.getStyle(e, "left"), 10);
        ...
        function i(e) {
            var t = {data: ""};
            this.options = utils.extend(t, e || {}), this.render(this.options.data, this.options.qType)
        }
        ...
        return i.prototype.render = function (e, t) {
            ...
            var i = document.createElement("div");
            i.className = "bcse-wn-card", i.id = "bdcsWnCard", document.body.appendChild(i), i.innerHTML = wncardTpl;
            var n = utils.getElementsByClassName("bcse-card-query")[0];
            n.innerHTML = e.query, n.setAttribute("title", e.query);
            var s = utils.getElementsByClassName("bcse-card-first-link")[0];
            s.innerHTML = e.results[0].title.replace(/<em>/g, "").replace(/<\/em>/g, ""), s.setAttribute("title", e.results[0].title.replace(/<em>/g, "").replace(/<\/em>/g, "")), s.setAttribute("href", e.results[0].url);
            var o = utils.getElementsByClassName("bcse-card-next-link")[0];
            o.innerHTML = e.results[1].title.replace(/<em>/g, "").replace(/<\/em>/g, ""), o.setAttribute("title", e.results[1].title.replace(/<em>/g, "").replace(/<\/em>/g, "")), o.setAttribute("href", e.results[1].url);
            ...
            e.results[0].img ? a.setAttribute("src", "http://znsv.baidu.com/static/customer-search/html/wncard.html?a=" + e.results[0].url + "&q=" + utils.getElementsByClassName("bcse-card-query")[0].getAttribute("title") + "&s=" + siteConfig.siteId + "&p=" + window.location.href + "&t=" + t + "#" + e.results[0].img) : a.style.display = "none", window.bdcsMncardMtd = 1, window.bdcsMncardReady = 1;
            ...
            l >= (c - document.documentElement.clientHeight) / 2 && 1 === window.bdcsMncardMtd && (document.getElementById("bdcsWnCard").style.display = "block", document.getElementById("bdcsWnCard").style.left = 0), this.bind(t)
        }, i.prototype.bind = function (i) {
            utils.addEvent(utils.getElementsByClassName("bcse-card-close")[0], "click", function () {
            ...
            for (var o = 0; o < document.getElementById("bdcsWnCard").getElementsByTagName("a").length; o++) utils.addEvent(document.getElementById("bdcsWnCard").getElementsByTagName("a")[o], "click", function () {
    ...
    !function () {
        ...
        var t,
            i = ["kujiale.com", "xhton.com", "9939.com", "xin.52pk.com", "dnf.52pk.com", "xwh.cn", "shangxueba.com", "benshouji.com", "yaoqi.cc", "jiaodong.net", "jingyan.39.net", "www.nxing.cn", "www.100xhs.com", "www.fjndwb.com", "www.hebnews.cn", "www.sqtv.net", "cd.bendibao.com", "www.7y7.com", "jbk.39.net", "ask.39.net"],
            ...
            s = 0, o = {s: siteConfig.siteId, locUrl: window.location.href},
        ...
        if (r) {
            ...
            if (decodeURIComponent(r) && (a = decodeURIComponent(r)), l = a.split("?"), l[1]) for (var d = l[1].split("&"), u = 0; u < d.length; u++) {
                var g = d[u].split("=")[0], p = d[u].split("=")[1];
                g && p && (c[g] = p)
            }
            var f = /www\.baidu\.com/, m = /cse\/search/;
        ...
        if (!o.q) {
            ...
            "" === b && document.title && (b = document.title, 1 !== t && (t = 4)), "" !== b && (o.q = b)
        }
        ...
        for (var u = 0; u < i.length; u++) window.location.href.indexOf(i[u]) >= 0 && 0 === s && 0 === e() && !document.getElementById("bdcsWnCard") && (o.q || o.eqid) && (FlyJSONP.init(), FlyJSONP.get({
            ...
            parameters: o,
            success: function (e) {
                e && 0 === e.error && e.results.length > 1 && new Card({data: e, qType: t})
            }
        }))
    }();
})();